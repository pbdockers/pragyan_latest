...
`,nl=y.iK.span`
  font-weight: ${e=>{let{theme:t}=e;return t.typography.weights.bold}};
`;function il(e){let{body:t,level:n="error",title:i}=e;const r=(0,y.Fg)().colors[n].base;return(0,x.tZ)(el,{level:n,role:"alert"},"error"===n?(0,x.tZ)(Y.Z.ErrorSolid,{iconColor:r}):(0,x.tZ)(Y.Z.WarningSolid,{iconColor:r}),(0,x.tZ)(tl,null,(0,x.tZ)(nl,null,i),(0,x.tZ)("p",null,t)))}var rl=n(72875),ol=n(77997),al=n(52794);const sl=_()(((e,t)=>{e(t?(0,al.qN)(t):(0,al.DU)())}),Tt.oP),ll=_()(((e,t)=>{e(t?(0,al.$7)(t):(0,al.Up)())}),Tt.oP);var dl=n(1510);const cl=()=>(0,r.v9)((e=>{var t;return{outlinedFilterId:null==(t=na(e.dashboardState.directPathToChild||[]))?void 0:t.native_filter,lastUpdated:e.dashboardState.directPathLastUpdated}})),ul=y.iK.div`
  & > div {
    height: auto !important;
    min-height: ${32}px;
  }
`,hl=[{data:[{}]}],pl=[wi.cg.NATIVE_FILTER],ml=e=>{var t,n,i;let{dataMaskSelected:o,filter:a,onFilterSelectionChange:l,inView:d=!0,showOverflow:h,parentRef:m,setFilterActive:g,orientation:f=Fi.Bp.VERTICAL,overflow:v=!1}=e;const{id:b,targets:y,filterType:S,adhoc_filters:C,time_range:Z}=a,w=(0,Zi.Z)().get(S),R=function(e,t){const n=(0,r.v9)((t=>{var n;return null==(n=t.nativeFilters.filters[e])?void 0:n.cascadeParentIds}));return(0,s.useMemo)((()=>{let e={};return(0,Qr.Z)(n).forEach((n=>{const i=null==t?void 0:t[n];e=(0,dl.on)(e,null==i?void 0:i.extraFormData)})),e}),[t,n])}(b,o),k=(()=>{const e=(0,r.v9)((e=>e.dashboardState.isRefreshing)),t=(0,r.v9)((e=>e.dashboardState.isFiltersRefreshing));return!e&&t})(),[T,$]=(0,s.useState)([]),[D,_]=(0,s.useState)(),[I,F]=(0,s.useState)({inView:!1}),[M,E]=(0,s.useState)({}),[O,z]=(0,s.useState)(d),U=(0,s.useRef)(null),[P]=y,{datasetId:N,column:A={}}=P,{name:q}=A,L=!!N,[j,V]=(0,s.useState)(L),[K,B]=(0,s.useState)(!1),H=(0,r.I0)(),{outlinedFilterId:W,lastUpdated:Y}=cl(),J=(0,s.useCallback)((()=>{B(!1),V(!1),k&&H((0,Yn.YC)())}),[H,k]);(0,s.useEffect)((()=>{!O&&d&&z(!0)}),[d,O,z]),(0,s.useEffect)((()=>{var e;if(!O)return;const t=(0,dl.zi)({...a,datasetId:N,dependencies:R,groupby:q,adhoc_filters:C,time_range:Z}),n=(null==(e=a.dataMask)?void 0:e.ownState)||{};if(!K&&(!Gs()(I,t,((e,t,n)=>"url_params"===n||void 0))||!mi()(M,n)||k)){if(F(t),E(n),!L)return;B(!0),(0,ui.getChartDataRequest)({formData:t,force:!1,requestParams:{dashboardId:0},ownState:n}).then((e=>{let{response:t,json:n}=e;if((0,yt.c)(u.T.GLOBAL_ASYNC_QUERIES)){const e="result"in n?n.result[0]:n;if(200===t.status)$([e]),J();else{if(202!==t.status)throw new Error(`Received unexpected response status (${t.status}) while fetching chart data`);(0,ol.YJ)(e).then((e=>{$(e),J()})).catch((e=>{(0,ai.O$)(e).then((e=>{_(e),J()}))}))}}else $(n.result),_(void 0),J()})).catch((e=>{(0,ai.O$)(e).then((e=>{_(e),J()}))}))}}),[O,R,N,q,J,JSON.stringify(a),L,K,k]),(0,s.useEffect)((()=>{W&&W===a.id&&setTimeout((()=>{var e;null==U||null==(e=U.current)||e.focus()}),v?Tt.oP:0)}),[U,W,Y,a.id,v]);const X=(0,s.useCallback)((e=>l(a,e)),[a,l]),G=(0,s.useCallback)((()=>{W!==b&&ll(H,b)}),[H,b,W]),Q=(0,s.useCallback)((()=>{ll(H),W===b&&H((0,Yn.E2)([]))}),[H,b,W]),ee=(0,s.useCallback)((()=>sl(H,b)),[H,b]),te=(0,s.useCallback)((()=>sl(H)),[H]),ne=(0,s.useMemo)((()=>({setDataMask:X,setHoveredFilter:ee,unsetHoveredFilter:te,setFocusedFilter:G,unsetFocusedFilter:Q,setFilterActive:g})),[X,g,ee,te,G,Q]),ie=Ss(a,null==(t=a.dataMask)?void 0:t.filterState),re=(0,s.useMemo)((()=>{var e;return{...null==(e=a.dataMask)?void 0:e.filterState,validateStatus:ie&&"error"}}),[null==(n=a.dataMask)?void 0:n.filterState,ie]),oe=(0,s.useMemo)((()=>({filterBarOrientation:f,isOverflowingFilterBar:v})),[f,v]);var ae;return D?(0,x.tZ)(rl.Z,{error:null==(ae=D.errors)?void 0:ae[0],fallback:(0,x.tZ)(il,{title:(0,c.t)("Cannot load filter"),body:D.error,level:"error"})}):(0,x.tZ)(ul,null,j?(0,x.tZ)(p.Z,{position:"inline-centered"}):(0,x.tZ)(Qs.Z,{height:32,width:"100%",showOverflow:h,formData:I,displaySettings:oe,parentRef:m,inputRef:U,queriesData:L?T:hl,chartType:S,behaviors:pl,filterState:re,ownState:null==(i=a.dataMask)?void 0:i.ownState,enableNoResults:null==w?void 0:w.enableNoResults,isRefreshing:K,hooks:ne}))},gl=s.memo(ml);var fl=n(51794);const vl=e=>{var t,n;return(null==e||null==(t=e.meta)?void 0:t.text)||(null==e||null==(n=e.meta)?void 0:n.defaultText)||""},bl=e=>{var t,n;return(null==e||null==(t=e.meta)?void 0:t.sliceNameOverride)||(null==e||null==(n=e.meta)?void 0:n.sliceName)||(null==e?void 0:e.id)||""},yl=y.iK.div`
  ${e=>{let{theme:t}=e;return x.iv`
    display: flex;
    align-items: center;
    margin: ${t.gridUnit}px 0;
...
`,$l=y.iK.div`
  display: flex;
  align-items: center;
`,Dl=e=>{let{title:t,children:n,...i}=e;return(0,x.tZ)(re.u,ne()({title:t,placement:"bottom",overlayClassName:"filter-card-tooltip"},i),(0,x.tZ)(Tl,null,n))},_l=(e,t)=>Array.isArray(e)&&e.length>0?(0,x.tZ)(s.Fragment,null,(0,x.tZ)(kl,null,t,":"),(0,x.tZ)(Rl,null,e.map((e=>(0,x.tZ)("li",null,e))))):null,Il=s.memo((e=>{let{filter:t}=e;const n=(e=>{const t=(0,r.v9)((e=>e.dashboardLayout.present)),n=Oi();return(0,s.useMemo)((()=>{var i;let r;const o=t[X._4].children[0];if(o.startsWith("TABS-")&&(r=t[o].children),0===e.scope.rootPath.length)return;if(0===e.scope.excluded.length&&(e.scope.rootPath[0]===X._4||null!=(i=r)&&i.every((t=>{var n;return a()(n=e.scope.rootPath).call(n,t)}))))return{all:[(0,c.t)("All charts")]};if(0===e.scope.excluded.length&&r)return{tabs:e.scope.rootPath.map((e=>vl(t[e]))).filter(Boolean)};const s=Object.values(t).filter((e=>e.type===g.dW));if(e.scope.rootPath[0]===X._4)return{charts:n.filter((t=>{var n;return!a()(n=e.scope.excluded).call(n,t)})).map((e=>{const t=s.find((t=>t.meta.chartId===e));return bl(t)})).filter(Boolean)};if(r){const i=[...e.scope.rootPath],r=s.filter((e=>e.parents.some((e=>a()(i).call(i,e)))));e.scope.excluded.forEach((e=>{const t=i.findIndex((t=>{var n,i;return null==(n=r.find((t=>t.meta.chartId===e)))?void 0:a()(i=n.parents).call(i,t)}));t>-1&&i.splice(t,1)}));const o=n.filter((t=>{var n;return!a()(n=e.scope.excluded).call(n,t)})).reduce(((e,t)=>{const n=r.find((e=>e.meta.chartId===t&&e.parents.every((e=>!a()(i).call(i,e)))));return n&&e.push(n),e}),[]);return{tabs:i.map((e=>vl(t[e]))).filter(Boolean),charts:o.map(bl).filter(Boolean)}}}),[n,e.scope.excluded,e.scope.rootPath,t])})(t),i=(0,s.useRef)(null),o=(0,s.useRef)(null),[l,d]=(0,fl.Z)(i,o),u=(0,s.useMemo)((()=>0!==l&&n?n.all?(0,x.tZ)("span",null,(0,c.t)("All charts")):(0,x.tZ)("div",null,_l(n.tabs,(0,c.t)("Tabs")),_l(n.charts,(0,c.t)("Charts"))):null),[l,n]);return(0,x.tZ)(yl,null,(0,x.tZ)(xl,null,(0,c.t)("Scope")),(0,x.tZ)(Dl,{title:u},(0,x.tZ)(Sl,{ref:i},n?Object.values(n).flat().map(((e,t)=>(0,x.tZ)("span",{key:e},0===t?e:`, ${e}`))):(0,c.t)("None")),d>0&&(0,x.tZ)(wl,{ref:o},"+",l)))})),Fl=e=>{let{dependency:t,hasSeparator:n}=e;const i=(0,r.I0)(),o=(0,s.useCallback)((()=>{i((0,Yn.E2)([t.id]))}),[t.id,i]);return(0,x.tZ)("span",null,n&&(0,x.tZ)("span",null,", "),(0,x.tZ)(Zl,{role:"button",onClick:o,tabIndex:0},t.name))},Ml=s.memo((e=>{let{filter:t}=e;const n=(e=>{const t=(0,Qr.Z)(e.cascadeParentIds);return(0,r.v9)((e=>0===t.length?[]:t.reduce(((t,n)=>(t.push(e.nativeFilters.filters[n]),t)),[])))})(t),i=(0,s.useRef)(null),o=(0,s.useRef)(null),[a,l]=(0,fl.Z)(i,o),d=(0,y.Fg)(),u=(0,s.useMemo)((()=>a>0&&n?(0,x.tZ)(Rl,null,n.map((e=>(0,x.tZ)("li",null,(0,x.tZ)(Fl,{dependency:e}))))):null),[a,n]);return Array.isArray(n)&&0!==n.length?(0,x.tZ)(yl,null,(0,x.tZ)(xl,{css:x.iv`
          display: inline-flex;
          align-items: center;
        `},(0,c.t)("Dependent on")," ",(0,x.tZ)(Dl,{title:(0,c.t)("Filter only displays values relevant to selections made in other filters.")},(0,x.tZ)(Y.Z.Info,{iconSize:"m",iconColor:d.colors.grayscale.light1,css:x.iv`
              margin-left: ${d.gridUnit}px;
            `}))),(0,x.tZ)(Dl,{title:u},(0,x.tZ)(Sl,{ref:i},n.map(((e,t)=>(0,x.tZ)(Fl,{key:e.id,dependency:e,hasSeparator:0!==t})))),l&&(0,x.tZ)(wl,{ref:o},"+",a))):null}));var El=n(89734),Ol=n.n(El),zl=n(44908),Ul=n.n(zl);const Pl=y.iK.div`
  ${e=>{let{theme:t}=e;return`\n  cursor: pointer;\n  margin: ${4*t.gridUnit}px;\n  color: ${t.colors.primary.base};\n  &:hover {\n    color: ${t.colors.primary.dark1};\n  }\n`}}
`,Nl=y.iK.div`
  height: 100%;
  display: flex;
  flex-direction: column;
`,Al=[{label:(0,c.t)("Filter"),type:no.BE.NATIVE_FILTER},{label:(0,c.t)("Divider"),type:no.BE.DIVIDER}],ql=e=>{let{getFilterTitle:t,onChange:n,onAdd:i,onRemove:r,onRearrange:o,restoreFilter:a,currentFilterId:l,filters:d,removedFilters:u,erroredFilters:h}=e;const p=(0,s.useRef)(null),m=(0,y.Fg)(),g=(0,x.tZ)(kt.$,{mode:"horizontal"},Al.map((e=>(0,x.tZ)(kt.$.Item,{onClick:()=>{return t=e.type,i(t),void setTimeout((()=>{var e;const t=document.getElementById("native-filters-tabs");if(t){const e=t.getElementsByClassName("ant-tabs-nav-list")[0];e.scrollTop=e.scrollHeight}null==p||null==(e=p.current)||null==e.scroll||e.scroll({top:p.current.scrollHeight,behavior:"smooth"})}),0);var t}},e.label))));return(0,x.tZ)(Nl,null,(0,x.tZ)(H.Gj,{overlay:g,arrow:!0,placement:"topLeft",trigger:["hover"]},(0,x.tZ)(Pl,null,(0,x.tZ)("div",{className:"fa fa-plus"})," ",(0,x.tZ)("span",null,(0,c.t)("Add filters and dividers")))),(0,x.tZ)("div",{css:(0,x.iv)({height:"100%",overflowY:"auto",marginLeft:3*m.gridUnit},"","")},(0,x.tZ)(ur,{ref:p,filters:d,currentFilterId:l,removedFilters:u,getFilterTitle:t,erroredFilters:h,onChange:n,onRemove:r,onRearrange:o,restoreFilter:a})))},Ll=y.iK.div`
  display: flex;
  height: 100%;
`,jl=y.iK.div`
  flex-grow: 3;
...
`,Kl=e=>{let{getFilterTitle:t,onChange:n,onRemove:i,onRearrange:r,restoreFilter:o,onAdd:a,erroredFilters:s,children:l,currentFilterId:d,filters:c,removedFilters:u}=e;return(0,x.tZ)(Ll,null,(0,x.tZ)(Vl,null,(0,x.tZ)(ql,{currentFilterId:d,filters:c,removedFilters:u,erroredFilters:s,getFilterTitle:t,onChange:n,onAdd:e=>a(e),onRearrange:r,onRemove:e=>i(e),restoreFilter:o})),(0,x.tZ)(jl,null,l))};var Bl=n(88889),Hl=n(15926),Wl=n.n(Hl),Yl=n(43700),Jl=n(6412),Xl=n(1090),Gl=n(61890),Ql=n(78676);const ed=y.iK.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  align-items: flex-start;
...
`,nd=e=>{const{checked:t,disabled:n,title:i,tooltip:r,children:o,onChange:a=(()=>{}),initialValue:l=!1}=e,[d,c]=(0,s.useState)(l);return(0,s.useEffect)((()=>{void 0!==t&&c(t)}),[t]),(0,x.tZ)(ed,{checked:d},(0,x.tZ)(H.r4,{className:"checkbox",checked:d,disabled:n,onChange:e=>{const n=e.target.checked;void 0===t&&c(n),a(n)}},(0,x.tZ)(s.Fragment,null,i," ",r&&(0,x.tZ)(ee.V,{placement:"top",tooltip:r}))),d&&(0,x.tZ)(td,null,o))};var id=n(28291);function rd(e){var t;let{allowClear:n=!1,filterValues:i=(()=>!0),form:r,formField:o="column",filterId:l,datasetId:d,value:u,onChange:h,mode:p}=e;const[m,g]=(0,s.useState)(),{addDangerToast:f}=(0,kn.e1)(),v=(0,s.useCallback)((()=>{r.setFields([{name:["filters",l,o],touched:!1,value:null}])}),[r,l,o]),b=(0,s.useMemo)((()=>(0,Qr.Z)(m).filter(i).map((e=>e.column_name)).map((e=>({label:e,value:e})))),[m,i]),y=null==(t=r.getFieldValue("filters"))?void 0:t[l].filterType,S=(0,s.useMemo)((()=>null==m?void 0:m.find((e=>e.column_name===u))),[m,u]);return(0,s.useEffect)((()=>{S&&!i(S)&&v()}),[S,y,v]),(0,id.S)(d,(e=>{null!=e&&v(),null!=d&&(0,Jl.e)({endpoint:`/api/v1/dataset/${d}?q=${Wl().encode({columns:["columns.column_name","columns.is_dttm","columns.type_generic"]})}`}).then((e=>{let{json:{result:t}}=e;const n=Array.isArray(u)?u:[u];t.columns.some((e=>null==n?void 0:a()(n).call(n,e.column_name)))||v(),g(t.columns)}),(async e=>{const{error:t,message:n}=await(0,ai.O$)(e);let i=n||t||(0,c.t)("An error has occurred");"Forbidden"===n&&(i=(0,c.t)("You do not have permission to edit this dashboard")),f(i)}))})),(0,x.tZ)(H.Ph,{mode:p,value:"multiple"===p?u||[]:u,ariaLabel:(0,c.t)("Column select"),onChange:h,options:b,placeholder:(0,c.t)("Select a column"),notFoundContent:(0,c.t)("No compatible columns found"),showSearch:!0,allowClear:n})}var od=n(10752),ad=n.n(od);const sd={filter_time:[Bl.Z.TEMPORAL],filter_timegrain:[Bl.Z.TEMPORAL],filter_timecolumn:[Bl.Z.TEMPORAL],filter_select:[Bl.Z.BOOLEAN,Bl.Z.STRING,Bl.Z.NUMERIC,Bl.Z.TEMPORAL],filter_range:[Bl.Z.NUMERIC]},ld="filters",dd=function(e){void 0===e&&(e=!0);const[,t]=s.useState({});return s.useCallback((()=>{e&&t({})}),[e])},cd=(e,t,n)=>{const i=e.getFieldValue(ld)||{};e.setFields([{name:ld,value:{...i,[t]:{...i[t],...n}}}])},ud=e=>({value:e.id,label:e.table_name}),hd=e=>{const t=(0,Qr.Z)(null==e?void 0:e.column_types);return 0===t.length||a()(t).call(t,Bl.Z.TEMPORAL)},pd=e=>{let{onChange:t,value:n}=e;const i=(0,s.useCallback)((e=>{let{error:t,message:n}=e,i=n||t||(0,c.t)("An error has occurred");return"Forbidden"===n&&(i=(0,c.t)("You do not have permission to edit this dashboard")),i}),[]);return(0,x.tZ)(H.qb,{ariaLabel:(0,c.t)("Dataset"),value:n,options:async(e,t,n)=>{const r="table_name",o=Wl().encode({filters:[{col:r,opr:"ct",value:e}],page:t,page_size:n,order_column:r,order_direction:"asc"});return(0,Jl.e)({endpoint:`/api/v1/dataset/?q=${o}`}).then((e=>({data:e.json.result.map(ud),totalCount:e.json.count}))).catch((async e=>{const t=i(await(0,ai.O$)(e));throw new Error(t)}))},onChange:t,notFoundContent:(0,c.t)("No compatible datasets found")})},md=e=>(0,s.useMemo)((()=>(0,x.tZ)(pd,e)),[]),gd=e=>{var t,n,i;let{hasDefaultValue:r,filterId:o,hasDataset:a,form:s,setDataMask:l,formData:d,enableNoResults:u}=e;const h=(s.getFieldValue("filters")||{})[o],m=null==h?void 0:h.defaultValueQueriesData,g=a&&null===m,f=null==h||null==(t=h.defaultDataMask)||null==(n=t.filterState)?void 0:n.value,v=r&&null==f;return g?(0,x.tZ)(p.Z,{position:"inline-centered"}):(0,x.tZ)(Qs.Z,{height:32,width:"filter_time"===(null==h?void 0:h.filterType)?350:270,appSection:wi.Tr.FILTER_CONFIG_MODAL,behaviors:[wi.cg.NATIVE_FILTER],formData:d,queriesData:a?null==h?void 0:h.defaultValueQueriesData:[{data:[{}]}],chartType:null==h?void 0:h.filterType,hooks:{setDataMask:l},enableNoResults:u,filterState:{...null==h||null==(i=h.defaultDataMask)?void 0:i.filterState,validateMessage:v&&(0,c.t)("Value is required"),validateStatus:v&&"error"}})};var fd,vd=n(15208);!function(e){e[e.all=0]="all",e[e.specific=1]="specific"}(fd||(fd={}));const bd=y.iK.div`
  display: flex;
  flex-direction: column;
  & > * {
    margin-bottom: ${e=>{let{theme:t}=e;return t.gridUnit}}px;
...
`,yd=(0,y.iK)(H.qz.Item)`
  margin-bottom: 0;
`,xd=e=>{let{pathToFormValue:t=[],formScopingType:n,formFilterScope:i,forceUpdate:r,filterScope:o,updateFormValues:a,chartId:l,initiallyExcludedCharts:d}=e;const[u]=(0,s.useState)(o||Ai(l,d)),h=(0,s.useRef)(u),[p]=(0,s.useState)(qi(u,l)?fd.all:fd.specific),[m,g]=(0,s.useState)(!!o),f=(0,s.useCallback)((e=>{n===fd.specific&&(h.current=e.scope),a(e),g(!0)}),[n,a]),v=(0,s.useCallback)((()=>{if(o||m)return;const e=Ai(l,d);a({scope:e,scoping:qi(e,l)?fd.all:fd.specific})}),[l,o,m,d,a]);return(0,vd.d)(v),(0,x.tZ)(bd,null,(0,x.tZ)(yd,{name:[...t,"scoping"],initialValue:p},(0,x.tZ)(Bt.Y.Group,{onChange:e=>{let{target:{value:t}}=e;const n=t===fd.all?Ai(l):h.current;a({scope:n}),g(!0),r()}},(0,x.tZ)(Bt.Y,{value:fd.all},(0,c.t)("Apply to all panels")),(0,x.tZ)(Bt.Y,{value:fd.specific},(0,c.t)("Apply to specific panels")))),(0,x.tZ)(H.ZT.Text,{type:"secondary"},(null!=n?n:p)===fd.specific?(0,c.t)("Only selected panels will be affected by this filter"):(0,c.t)("All panels with this column will be affected by this filter")),(null!=n?n:p)===fd.specific&&(0,x.tZ)(Vi,{updateFormValues:f,initialScope:u,formScope:i,forceUpdate:r,chartId:l,initiallyExcludedCharts:d}),(0,x.tZ)(yd,{name:[...t,"scope"],hidden:!0,initialValue:u}))};var Sd=n(37687);const Cd=(0,y.iK)(At.xJ)`
  margin-bottom: 0;
`;const Zd=y.iK.div`
  display: flex;
  flex-direction: column;
  ...
  align-items: center;
  color: ${e=>{let{theme:t}=e;return t.colors.grayscale.base}};
`,wd=e=>{let{onClick:t}=e;return(0,x.tZ)(Zd,null,(0,x.tZ)("p",null,(0,c.t)("You have removed this filter.")),(0,x.tZ)("div",null,(0,x.tZ)(W.Z,{buttonStyle:"primary",onClick:t},(0,c.t)("Restore Filter"))))},Rd=y.iK.div`
  display: flex;
  flex-direction: column;
`,kd=y.iK.div`
  ${e=>{let{theme:t}=e;return`\n    display: inline-flex;\n    flex-direction: row;\n    align-items: center;\n    cursor: pointer;\n    color: ${t.colors.primary.base};\n    &:hover {\n      color: ${t.colors.primary.dark1};\n    }\n  `}}
...
`,Dd=y.iK.div`
  ...
  color: ${e=>{let{theme:t}=e;return t.colors.grayscale.base}};
  margin-bottom: ${e=>{let{theme:t}=e;return t.gridUnit}}px;
`,_d=e=>{let{availableFilters:t,selection:n,onChange:i,onDelete:r}=e,o=t.find((e=>e.value===n)),a=t;return o||(o={label:(0,c.t)("(deleted or invalid type)"),value:n},a=[o,...a]),(0,x.tZ)($d,null,(0,x.tZ)(H.Ph,{ariaLabel:(0,c.t)("Limit type"),labelInValue:!0,options:a,onChange:e=>i(n,e.value),value:o}),(0,x.tZ)(Td,{iconSize:"xl",onClick:()=>r(n)}))},Id=e=>{let{availableFilters:t=[],dependencies:n=[],onDependenciesChange:i}=e;const[r,o]=(0,s.useState)(n),l=e=>{o(e),i(e)},d=(e,t)=>{const n=r.findIndex((t=>t===e)),i=[...r];i[n]=t,l(i)},u=e=>{const t=[...r];t.splice(r.indexOf(e),1),l(t)};return 0===t.length?(0,x.tZ)("span",null,(0,c.t)("No available filters.")):(0,x.tZ)(s.Fragment,null,r.map((e=>(0,x.tZ)(_d,{key:e,selection:e,availableFilters:t.filter((t=>t.value===e||!a()(r).call(r,t.value))),onChange:d,onDelete:u}))),t.length>r.length&&(0,x.tZ)(kd,{onClick:()=>{const e=t.find((e=>!a()(r).call(r,e.value)));if(e){const t=[...r];t.push(e.value),l(t)}}},(0,x.tZ)(Y.Z.PlusSmall,null),(0,c.t)("Add filter")))},Fd=e=>{let{availableFilters:t=[],dependencies:n=[],onDependenciesChange:i,getDependencySuggestion:r,children:o}=e;const a=t.length>0,s=n.length>0;return(0,x.tZ)(Rd,null,(0,x.tZ)(nd,{title:(0,c.t)("Values are dependent on other filters"),initialValue:s,onChange:e=>{const t=[];e&&!s&&a&&t.push(r()),i(t)},tooltip:(0,c.t)("Values selected in other filters will affect the filter options to only show relevant values")},s&&(0,x.tZ)(Dd,null,(0,c.t)("Values dependent on")),(0,x.tZ)(Id,{availableFilters:t,dependencies:n,onDependenciesChange:i,getDependencySuggestion:r}),o))},Md=(0,y.iK)(R.ZP.TabPane)`
...
`,Od=y.iK.div`
  ...
  width: 100%;
  padding: 0px ${e=>{let{theme:t}=e;return 4*t.gridUnit}}px;
`,zd=["enableEmptyFilter","defaultToFirstItem","multiSelect","searchAllOptions","inverseSelection"],Ud=(0,y.iK)(At.xJ)`
  width: 49%;
...
`,Hd=y.iK.div`
  ${e=>{let{theme:t}=e;return`\n    width: 49%;\n    font-size: ${t.typography.sizes.s}px;\n    color: ${t.colors.grayscale.light1};\n    margin:\n      ${2*-t.gridUnit}px\n      0px\n      ${4*t.gridUnit}px\n      ${4*t.gridUnit}px;\n  `}}
`,Wd={configuration:{key:"configuration",name:(0,c.t)("Settings")},scoping:{key:"scoping",name:(0,c.t)("Scoping")}},Yd={configuration:{key:"configuration",name:(0,c.t)("Filter Configuration")},settings:{key:"settings",name:(0,c.t)("Filter Settings")}},Jd=["filter_select","filter_range"],Xd={[(0,c.t)("Select filter")]:(0,c.t)("Value"),[(0,c.t)("Range filter")]:(0,c.t)("Numerical range"),[(0,c.t)("Time filter")]:(0,c.t)("Time range"),[(0,c.t)("Time column")]:(0,c.t)("Time column"),[(0,c.t)("Time grain")]:(0,c.t)("Time grain"),[(0,c.t)("Group By")]:(0,c.t)("Group by")},Gd=(e,t)=>{var n,i,o,l,d,h,m,g,f,v,b,y,S,C,Z,w,R,k,T,$,D,_,I,F,M;let{filterId:E,filterToEdit:O,removedFilters:z,form:U,getAvailableFilters:P,activeFilterPanelKeys:N,restoreFilter:A,handleActiveFilterPanelChange:q,setErroredFilters:L,validateDependencies:j,getDependencySuggestion:V,isActive:K}=e;const W=!!z[E],[Y,J]=(0,s.useState)(),[X,G]=(0,s.useState)([]),[Q,te]=(0,s.useState)(Wd.configuration.key),[ie,oe]=(0,s.useState)(null),ae=dd(K),[se,le]=(0,s.useState)(),de=(0,s.useMemo)((()=>({})),[]),ce=U.getFieldValue("filters"),ue=null==ce?void 0:ce[E],he=ue||ie||de,pe=(null==he?void 0:he.dependencies)||(null==O?void 0:O.cascadeParentIds)||[],me=(0,Zi.Z)().items,ge=Object.entries(me).filter((e=>{var t;let[,{value:n}]=e;return null==(t=n.behaviors)?void 0:a()(t).call(t,wi.cg.NATIVE_FILTER)})).map((e=>{let[t]=e;return t})),fe=(0,r.v9)((e=>{let{datasources:t}=e;return t})),ve=(0,r.v9)((e=>{let{charts:t}=e;return t})),be=(0,s.useMemo)((()=>Object.values(fe).some((e=>hd(e)))),[fe]),ye=(0,s.useMemo)((()=>{const e=Object.values(fe).find((e=>{var t;return e.id===(null==he||null==(t=he.dataset)?void 0:t.value)}));return!e||hd(e)}),[null==he||null==(n=he.dataset)?void 0:n.value,fe]),xe=!(null==(i=me[null==he?void 0:he.filterType])||null==(o=i.value)||!o.datasourceCount),Se=null!=(l=null!=(d=null==he||null==(h=he.dataset)?void 0:h.value)?d:null==O||null==(m=O.targets[0])?void 0:m.datasetId)?l:((e,t)=>{var n;const i=new Map;let r="",o=0;return Object.values(t).forEach((e=>{const{form_data:t}=e;if(t){const{datasource:e}=t,n=(i.get(e)||0)+1;i.set(e,n),n>o&&(o=n,r=e)}})),null==(n=e[r])?void 0:n.id})(fe,ve),{controlItems:Ce={},mainControlItems:Ze={}}=he?function(e){var t;let{datasetId:n,disabled:i,forceUpdate:r,form:o,filterId:l,filterType:d,filterToEdit:u,formFilter:h,removed:p}=e;const m=null!=(void 0===(g=(0,Sd.Z)().get(d))&&(g={}),t=null!=(f=null==(v=ad()(g.controlPanelSections))?void 0:v.reduce(((e,t)=>{let{controlSetRows:n=[]}=t;return[...e,...ad()(n)]}),[]))?f:[])?t:[];var g,f,v;const b={},y={};return m.filter((e=>"groupby"===(null==e?void 0:e.name))).forEach((e=>{var t,i,d,m,g,f,v,b,S;const C=null!=(t=null==u||null==(i=u.controlValues)?void 0:i[e.name])?t:null==e||null==(d=e.config)?void 0:d.default,Z=null==u||null==(m=u.targets[0])||null==(g=m.column)?void 0:g.name,w=(0,x.tZ)(s.Fragment,null,(0,x.tZ)(Cd,{name:["filters",l,"requiredFirst",e.name],hidden:!0,initialValue:(null==e||null==(f=e.config)?void 0:f.requiredFirst)&&(null==u?void 0:u.requiredFirst)}),(0,x.tZ)(Ud,{name:["filters",l,"column"],initialValue:Z,label:(0,x.tZ)(Ad,null,(null==(v=e.config)?void 0:v.label)||(0,c.t)("Column")),rules:[{required:(null==(b=e.config)?void 0:b.required)&&!p,message:(0,c.t)("Column is required")}]},(0,x.tZ)(rd,{mode:(null==(S=e.config)?void 0:S.multiple)&&"multiple",form:o,filterId:l,datasetId:n,filterValues:e=>((e,t)=>{var n;return!t.type_generic||!(e in sd)||(null==(n=sd[e])?void 0:a()(n).call(n,t.type_generic))})((null==h?void 0:h.filterType)||"",e),onChange:()=>{cd(o,l,{defaultDataMask:null}),r()}})));y[e.name]={element:w,checked:C}})),m.filter((e=>{var t;return(null==e||null==(t=e.config)?void 0:t.renderTrigger)&&"sortAscending"!==e.name&&"enableSingleValue"!==e.name})).forEach((e=>{var t,n,a,d;const p=null!=(t=null==u||null==(n=u.controlValues)?void 0:n[e.name])?t:null==e||null==(a=e.config)?void 0:a.default,m=(0,x.tZ)(s.Fragment,null,(0,x.tZ)(Cd,{name:["filters",l,"requiredFirst",e.name],hidden:!0,initialValue:(null==e||null==(d=e.config)?void 0:d.requiredFirst)&&(null==u?void 0:u.requiredFirst)}),(0,x.tZ)(re.u,{key:e.name,placement:"left",title:e.config.affectsDataMask&&i&&(0,c.t)('Populate "Default value" to enable this control')},(0,x.tZ)(Pd,{key:e.name,name:["filters",l,"controlValues",e.name],initialValue:p,valuePropName:"checked",colon:!1},(0,x.tZ)(H.r4,{disabled:e.config.affectsDataMask&&i,onChange:t=>{let{target:{checked:n}}=t;e.config.requiredFirst&&cd(o,l,{requiredFirst:{...null==h?void 0:h.requiredFirst,[e.name]:n}}),e.config.resetConfig&&cd(o,l,{defaultDataMask:null}),r()}},e.config.label," ",e.config.description&&(0,x.tZ)(ee.V,{placement:"top",label:e.config.name,tooltip:e.config.description})))));b[e.name]={element:m,checked:p}})),{controlItems:b,mainControlItems:y}}({datasetId:Se,disabled:!1,forceUpdate:ae,form:U,filterId:E,filterType:null==he?void 0:he.filterType,filterToEdit:O,formFilter:he,removed:W}):{},we=!!Ze.groupby,Re=!(null==(f=(null!=(g=me[null==he?void 0:he.filterType])?g:{}).value)||!f.enableNoResults),ke=we&&!!X.length,Te=!xe||Se&&((null==he?void 0:he.column)||!we),$e=a()(Jd).call(Jd,null==he?void 0:he.filterType),De=a()(cc).call(cc,null==he?void 0:he.filterType),_e=null==(v=null==he?void 0:he.isDataDirty)||v,Ie=e=>{cd(U,E,e),J(void 0),ae()};let Fe={};pe&&pe.length>0&&ce&&pe.forEach((e=>{var t,n;const i=null==(t=ce[e])||null==(n=t.defaultDataMask)?void 0:n.extraFormData;Fe=(0,dl.on)(Fe,i)}));const Me=JSON.stringify(Fe),Ee=(0,s.useCallback)((function(e){var t,n;if(void 0===e&&(e=!1),!xe||null==he||null==(t=he.dataset)||!t.value)return void ae();const i=(0,dl.zi)({datasetId:null==he||null==(n=he.dataset)?void 0:n.value,groupby:null==he?void 0:he.column,...he});i.extra_form_data=Fe,Ie({defaultValueQueriesData:null,isDataDirty:!1}),(0,ui.getChartDataRequest)({formData:i,force:e,requestParams:{dashboardId:0}}).then((e=>{let{response:t,json:n}=e;if((0,yt.c)(u.T.GLOBAL_ASYNC_QUERIES)){const e="result"in n?n.result[0]:n;if(200===t.status)Ie({defaultValueQueriesData:[e]});else{if(202!==t.status)throw new Error(`Received unexpected response status (${t.status}) while fetching chart data`);(0,ol.YJ)(e).then((e=>{Ie({defaultValueQueriesData:e})})).catch((e=>{(0,ai.O$)(e).then((e=>{(e=>{cd(U,E,{defaultValueQueriesData:null}),J(e),ae()})(e)}))}))}}else Ie({defaultValueQueriesData:n.result})})).catch((e=>{(0,ai.O$)(e).then((e=>{J(e)}))}))}),[E,ae,U,he,xe,Me]);(0,s.useEffect)((()=>Ee()),[Me]);const Oe=(0,dl.zi)({datasetId:Se,groupby:we?null==he?void 0:he.column:void 0,...he});Oe.extra_form_data=Fe;const[ze,Ue,Pe,Ne]=((e,t)=>{var n,i;const r=!(null==e||null==(n=e.controlValues)||!n.enableEmptyFilter),o=!(null==e||null==(i=e.controlValues)||!i.defaultToFirstItem),[a,l]=(0,s.useState)(!1),[d,u]=(0,s.useState)(r),[h,p]=(0,s.useState)(""),m=function(e){void 0===e&&(e=!1);const t=r&&!o;u(t),l(!!t||e)};return(0,s.useEffect)((()=>{var t,n;m(!o&&!(null==e||null==(t=e.defaultDataMask)||null==(n=t.filterState)||!n.value))}),[o,r]),(0,s.useEffect)((()=>{var e,n;m(!o&&!(null==t||null==(e=t.defaultDataMask)||null==(n=e.filterState)||!n.value))}),[]),(0,s.useEffect)((()=>{let e="";o?e=(0,c.t)('Default value set automatically when "Select first filter value by default" is checked'):d?e=(0,c.t)('Default value must be set when "Filter value is required" is checked'):a&&(e=(0,c.t)('Default value must be set when "Filter has default value" is checked')),p(e)}),[a,d,o]),[a,d,h,m]})(he,O),Ae=!Se||se||(null==he||null==(b=he.dataset)?void 0:b.label),qe=(0,s.useCallback)((()=>{U.setFields([{name:"changed",value:!0}])}),[U]),Le=(0,s.useCallback)((e=>{cd(U,E,e),qe()}),[E,U,qe]),je=!!(null!=he&&he.adhoc_filters||null!=he&&he.time_range||null!=O&&null!=(y=O.adhoc_filters)&&y.length||null!=O&&O.time_range),Ve=void 0!==(null==he||null==(S=he.controlValues)?void 0:S.enableSingleValue)||void 0!==(null==O||null==(C=O.controlValues)?void 0:C.enableSingleValue);let Ke=null==O||null==(Z=O.controlValues)?void 0:Z.enableSingleValue;void 0!==(null==he||null==(w=he.controlValues)?void 0:w.enableSingleMaxValue)&&({enableSingleValue:Ke}=he.controlValues);const Be="boolean"==typeof(null==he||null==(R=he.controlValues)?void 0:R.sortAscending)||"boolean"==typeof(null==O||null==(k=O.controlValues)?void 0:k.sortAscending);let He=null==O||null==(T=O.controlValues)?void 0:T.sortAscending;"boolean"==typeof(null==he||null==($=he.controlValues)?void 0:$.sortAscending)&&(He=he.controlValues.sortAscending);const We=!xe||!_e&&Te||!Ze.groupby,Ye=e=>{var t;const n=null==(t=U.getFieldValue("filters"))?void 0:t[E].controlValues;cd(U,E,{controlValues:{...n,sortAscending:e}}),ae()},Je=e=>{var t;const n=null==(t=U.getFieldValue("filters"))?void 0:t[E].controlValues;cd(U,E,{controlValues:{...n,enableSingleValue:e}}),ae()},Xe=()=>setTimeout((()=>U.validateFields([["filters",E,"adhoc_filters"],["filters",E,"time_range"]])),0),Ge=(null==he?void 0:he.time_range)&&"No filter"!==he.time_range,Qe=(null==he||null==(D=he.adhoc_filters)?void 0:D.length)>0,et=null==he||null==(_=he.controlValues)?void 0:_.defaultToFirstItem,tt=(null==he?void 0:he.filterType)===(null==O?void 0:O.filterType)?null==O?void 0:O.defaultDataMask:null,nt=()=>Ge||Qe?Promise.resolve():Promise.reject(new Error((0,c.t)("Pre-filter is required"))),it=P(E),rt=it.length>0,ot=it.filter((e=>"filter_time"===e.type)).some((e=>null==pe?void 0:a()(pe).call(pe,e.value)));(0,s.useEffect)((()=>{Se&&(0,Jl.e)({endpoint:`/api/v1/dataset/${Se}?q=${Wl().encode({columns:["columns.column_name","columns.expression","columns.filterable","columns.is_dttm","columns.type","columns.verbose_name","database.id","database.database_name","datasource_type","filter_select_enabled","id","is_sqllab_view","main_dttm_col","metrics.metric_name","metrics.verbose_name","schema","sql","table_name"]})}`}).then((e=>{var t,n,i;G(null==(t=e.json)||null==(n=t.result)?void 0:n.metrics);const r=null==(i=e.json)?void 0:i.result;r.type=r.datasource_type,r.filter_select=!0,le(r)})).catch((e=>{(0,Xn.Gb)(e.message)}))}),[Se]),(0,s.useImperativeHandle)(t,(()=>({changeTab(e){te(e)}}))),((e,t)=>{var n;const i=dd(),r=(e.getFieldValue("filters")||{})[t];(0,s.useEffect)((()=>{cd(e,t,{isDataDirty:!0,defaultValueQueriesData:null}),i()}),[e,null==r?void 0:r.filterType,null==r?void 0:r.column,null==r||null==(n=r.dataset)?void 0:n.value,JSON.stringify(null==r?void 0:r.adhoc_filters),null==r?void 0:r.time_range,i,t])})(U,E),(0,s.useEffect)((()=>{xe&&Te&&ze&&_e&&Ee()}),[xe,Te,ze,_e,Ee,Ae]);const at=(0,s.useMemo)((()=>{var e;const t=[];return void 0===(null==he||null==(e=he.dataset)?void 0:e.value)?[]:(Object.values(ve).forEach((e=>{var n,i,r;const o=null==(n=e.form_data)?void 0:n.datasource;void 0!==o&&(null==(i=fe[o])?void 0:i.id)!==(null==he||null==(r=he.dataset)?void 0:r.value)&&t.push(e.id)})),t)}),[JSON.stringify(ve),null==he||null==(I=he.dataset)?void 0:I.value,JSON.stringify(fe)]);if((0,s.useEffect)((()=>{W&&oe(ue)}),[W]),(0,s.useEffect)((()=>{ie&&!W&&(cd(U,E,ie),oe(null))}),[ue,E,U,W,ie]),W)return(0,x.tZ)(wd,{onClick:()=>A(E)});const st=(0,x.tZ)(Pd,{name:["filters",E,"granularity_sqla"],label:(0,x.tZ)(s.Fragment,null,(0,x.tZ)(Ad,null,(0,c.t)("Time column"))," ",(0,x.tZ)(ee.V,{placement:"top",tooltip:ot?(0,c.t)("Time column to apply dependent temporal filter to"):(0,c.t)("Time column to apply time range to")})),initialValue:null==O?void 0:O.granularity_sqla},(0,x.tZ)(rd,{allowClear:!0,form:U,formField:"granularity_sqla",filterId:E,filterValues:e=>!!e.is_dttm,datasetId:Se,onChange:e=>{cd(U,E,{granularity_sqla:e}),ae()}}));return(0,x.tZ)(Kd,{activeKey:Q,onChange:e=>te(e),centered:!0},(0,x.tZ)(Md,{tab:Wd.configuration.name,key:Wd.configuration.key,forceRender:!0},(0,x.tZ)(Ed,null,(0,x.tZ)(Ud,{name:["filters",E,"type"],hidden:!0,initialValue:no.BE.NATIVE_FILTER},(0,x.tZ)(B.II,null)),(0,x.tZ)(Ud,{name:["filters",E,"name"],label:(0,x.tZ)(Ad,null,(0,c.t)("Filter name")),initialValue:null==O?void 0:O.name,rules:[{required:!W,message:(0,c.t)("Name is required")}]},(0,x.tZ)(B.II,dc("name-input"))),(0,x.tZ)(Ud,ne()({name:["filters",E,"filterType"],rules:[{required:!W,message:(0,c.t)("Name is required")}],initialValue:(null==O?void 0:O.filterType)||"filter_select",label:(0,x.tZ)(Ad,null,(0,c.t)("Filter Type"))},dc("filter-type")),(0,x.tZ)(H.Ph,{ariaLabel:(0,c.t)("Filter type"),options:ge.map((e=>{var t,n,i;const r=null==(t=me[e])?void 0:t.value.name,o=r?Xd[r]:void 0,s=1===(null==(n=sd[e])?void 0:n.length)&&(null==(i=sd[e])?void 0:a()(i).call(i,Bl.Z.TEMPORAL))&&!be;return{value:e,label:o||r,customLabel:s?(0,x.tZ)(re.u,{title:(0,c.t)("Datasets do not contain a temporal column")},o||r):void 0,disabled:s}})),onChange:e=>{cd(U,E,{filterType:e,defaultDataMask:null,column:null}),ae()}}))),"filter_time"===(null==he?void 0:he.filterType)&&(0,x.tZ)(Hd,null,(0,c.t)("Dashboard time range filters apply to temporal columns defined in\n          the filter section of each chart. Add temporal columns to the chart\n          filters to have this dashboard filter impact those charts.")),xe&&(0,x.tZ)(Od,null,Ae?(0,x.tZ)(Ud,ne()({name:["filters",E,"dataset"],label:(0,x.tZ)(Ad,null,(0,c.t)("Dataset")),initialValue:se?{label:se.table_name,value:se.id}:void 0,rules:[{required:!W,message:(0,c.t)("Dataset is required")}]},dc("datasource-input")),(0,x.tZ)(md,{onChange:e=>{e.value!==Se&&cd(U,E,{dataset:e,defaultDataMask:null,column:null}),ae()}})):(0,x.tZ)(Ud,{label:(0,x.tZ)(Ad,null,(0,c.t)("Dataset"))},(0,x.tZ)(p.Z,{position:"inline-centered"})),xe&&Object.keys(Ze).map((e=>Ze[e].element))),(0,x.tZ)(Vd,{defaultActiveKey:N,onChange:e=>{q(e)},expandIconPosition:"right",key:`native-filter-config-${E}`},"filter_time"!==(null==he?void 0:he.filterType)&&(0,x.tZ)(Yl.Z.Panel,{forceRender:!0,header:Yd.configuration.name,key:`${E}-${Yd.configuration.key}`},De&&rt&&(0,x.tZ)(Pd,{name:["filters",E,"dependencies"],initialValue:pe},(0,x.tZ)(Fd,{availableFilters:it,dependencies:pe,onDependenciesChange:e=>{cd(U,E,{dependencies:e}),ae(),j(),qe()},getDependencySuggestion:()=>V(E)},ot?st:void 0)),xe&&$e&&(0,x.tZ)(qd,{name:["filters",E,"preFilter"]},(0,x.tZ)(nd,{initialValue:je,title:(0,c.t)("Pre-filter available values"),tooltip:(0,c.t)("Add filter clauses to control the filter's source query,\n                    though only in the context of the autocomplete i.e., these conditions\n                    do not impact how the filter is applied to the dashboard. This is useful\n                    when you want to improve the query's performance by only scanning a subset\n                    of the underlying data or limit the available values displayed in the filter."),onChange:e=>{qe(),e&&Xe()}},(0,x.tZ)(Nd,{name:["filters",E,"adhoc_filters"],css:(0,x.iv)({width:270},"",""),initialValue:null==O?void 0:O.adhoc_filters,required:!0,rules:[{validator:nt}]},(0,x.tZ)(Gl.Z,{columns:(null==se||null==(F=se.columns)?void 0:F.filter((e=>e.filterable)))||[],savedMetrics:(null==se?void 0:se.metrics)||[],datasource:se,onChange:e=>{cd(U,E,{adhoc_filters:e}),ae(),Xe()},label:(0,x.tZ)("span",null,(0,x.tZ)(Ad,null,(0,c.t)("Pre-filter")),!Ge&&(0,x.tZ)(Bd,null))})),ye&&(0,x.tZ)(Pd,{name:["filters",E,"time_range"],label:(0,x.tZ)(Ad,null,(0,c.t)("Time range")),initialValue:(null==O?void 0:O.time_range)||(0,c.t)("No filter"),required:!Qe,rules:[{validator:nt}]},(0,x.tZ)(Xl.ZP,{name:"time_range",onChange:e=>{cd(U,E,{time_range:e}),ae(),Xe()}})),Ge&&!ot?st:void 0)),"filter_range"!==(null==he?void 0:he.filterType)?(0,x.tZ)(qd,{name:["filters",E,"sortFilter"]},(0,x.tZ)(nd,{initialValue:Be,title:(0,c.t)("Sort filter values"),onChange:e=>{Ye(e||void 0),qe()}},(0,x.tZ)(Pd,{name:["filters",E,"controlValues","sortAscending"],initialValue:He,label:(0,x.tZ)(Ad,null,(0,c.t)("Sort type"))},(0,x.tZ)(Bt.Y.Group,{onChange:e=>{Ye(e.target.value)}},(0,x.tZ)(Bt.Y,{value:!0},(0,c.t)("Sort ascending")),(0,x.tZ)(Bt.Y,{value:!1},(0,c.t)("Sort descending")))),ke&&(0,x.tZ)(Nd,{name:["filters",E,"sortMetric"],initialValue:null==O?void 0:O.sortMetric,label:(0,x.tZ)(s.Fragment,null,(0,x.tZ)(Ad,null,(0,c.t)("Sort Metric"))," ",(0,x.tZ)(ee.V,{placement:"top",tooltip:(0,c.t)("If a metric is specified, sorting will be done based on the metric value")}))},(0,x.tZ)(H.Ph,{allowClear:!0,ariaLabel:(0,c.t)("Sort metric"),name:"sortMetric",options:X.map((e=>{var t;return{value:e.metric_name,label:null!=(t=e.verbose_name)?t:e.metric_name}})),onChange:e=>{void 0!==e&&(cd(U,E,{sortMetric:e}),ae())}})))):(0,x.tZ)(qd,{name:["filters",E,"rangeFilter"]},(0,x.tZ)(nd,{initialValue:Ve,title:(0,c.t)("Single Value"),onChange:e=>{Je(e?Ql.c.Exact:void 0),qe()}},(0,x.tZ)(Pd,{name:["filters",E,"controlValues","enableSingleValue"],initialValue:Ke,label:(0,x.tZ)(Ad,null,(0,c.t)("Single value type"))},(0,x.tZ)(Bt.Y.Group,{onChange:e=>Je(e.target.value)},(0,x.tZ)(Bt.Y,{value:Ql.c.Minimum},(0,c.t)("Minimum")),(0,x.tZ)(Bt.Y,{value:Ql.c.Exact},(0,c.t)("Exact")),(0,x.tZ)(Bt.Y,{value:Ql.c.Maximum},(0,c.t)("Maximum"))))))),(0,x.tZ)(Yl.Z.Panel,{forceRender:!0,header:Yd.settings.name,key:`${E}-${Yd.settings.key}`},(0,x.tZ)(Ud,{name:["filters",E,"description"],initialValue:null==O?void 0:O.description,label:(0,x.tZ)(Ad,null,(0,c.t)("Description"))},(0,x.tZ)(B.Kx,null)),(0,x.tZ)(qd,{name:["filters",E,"defaultValueQueriesData"],hidden:!0,initialValue:null}),(0,x.tZ)(qd,{name:["filters",E,"defaultValue"]},(0,x.tZ)(nd,{checked:ze,disabled:Ue||et,initialValue:ze,title:(0,c.t)("Filter has default value"),tooltip:Pe,onChange:e=>{Ne(e),e||cd(U,E,{defaultDataMask:null}),qe()}},!W&&(0,x.tZ)(Nd,{name:["filters",E,"defaultDataMask"],initialValue:tt,label:(0,x.tZ)(Ad,null,(0,c.t)("Default Value")),required:ze,rules:[{validator:()=>{var e,t;if(null!=he&&null!=(e=he.defaultDataMask)&&null!=(t=e.filterState)&&t.value){const e=U.getFieldsError();return L((t=>t.length&&!e.find((e=>e.errors.length>0))?[]:t)),Promise.resolve()}return L((e=>a()(e).call(e,E)?e:[...e,E])),Promise.reject(new Error((0,c.t)("Default value is required")))}}]},Y||We?(0,x.tZ)(Ld,null,Y?(0,x.tZ)(rl.Z,{error:null==(M=Y.errors)?void 0:M[0],fallback:(0,x.tZ)(il,{title:(0,c.t)("Cannot load filter"),body:Y.error,level:"error"})}):(0,x.tZ)(gd,{setDataMask:e=>{var t,n;mi()(null==tt||null==(t=tt.filterState)?void 0:t.value,null==e||null==(n=e.filterState)?void 0:n.value)||qe(),cd(U,E,{defaultDataMask:e}),U.validateFields([["filters",E,"defaultDataMask"]]),ae()},hasDefaultValue:ze,filterId:E,hasDataset:xe,form:U,formData:Oe,enableNoResults:Re}),xe&&Se&&(0,x.tZ)(re.u,{title:(0,c.t)("Refresh the default values")},(0,x.tZ)(jd,{onClick:()=>Ee(!0)}))):(0,c.t)('Fill all required fields to enable "Default Value"')))),Object.keys(Ce).sort(((e,t)=>zd.indexOf(e)-zd.indexOf(t))).map((e=>Ce[e].element))))),(0,x.tZ)(Md,{tab:Wd.scoping.name,key:Wd.scoping.key,forceRender:!0},(0,x.tZ)(xd,{updateFormValues:Le,pathToFormValue:["filters",E],forceUpdate:ae,filterScope:null==O?void 0:O.scope,formFilterScope:null==he?void 0:he.scope,formScopingType:null==he?void 0:he.scoping,initiallyExcludedCharts:at})))},Qd=s.memo((0,s.forwardRef)(Gd));var ec={name:"ihui0v",styles:"text-align:left;& .ant-alert-action{align-self:center;}"},tc={name:"zjik7",styles:"display:flex"};function nc(e){let{title:t,onConfirm:n,onDismiss:i,children:r}=e;return(0,x.tZ)(Nt.Z,{closable:!1,type:"warning",key:"alert",message:t,css:ec,description:r,action:(0,x.tZ)("div",{css:tc},(0,x.tZ)(W.Z,{key:"cancel",buttonSize:"small",buttonStyle:"secondary",onClick:i},(0,c.t)("Keep editing")),(0,x.tZ)(W.Z,{key:"submit",buttonSize:"small",buttonStyle:"primary",onClick:n},(0,c.t)("Yes, cancel")))})}const ic=e=>{let{canSave:t=!0,onCancel:n,handleSave:i,onDismiss:r,onConfirmCancel:o,saveAlertVisible:a}=e;return a?(0,x.tZ)(nc,{key:"cancel-confirm",title:(0,c.t)("There are unsaved changes."),onConfirm:o,onDismiss:r},(0,c.t)("Are you sure you want to cancel?")):(0,x.tZ)(s.Fragment,null,(0,x.tZ)(W.Z,{key:"cancel",buttonStyle:"secondary",onClick:n},(0,c.t)("Cancel")),(0,x.tZ)(W.Z,{disabled:!t,key:"submit",buttonStyle:"primary",onClick:i},(0,c.t)("Save")))},rc=y.iK.div`
  ${e=>{let{theme:t}=e;return`\n    padding: ${4*t.gridUnit}px;\n  `}}
`,oc=e=>{let{componentId:t,divider:n}=e;return(0,x.tZ)(rc,null,(0,x.tZ)(At.xJ,{initialValue:n?n.title:"",label:(0,c.t)("Title"),name:["filters",t,"title"],rules:[{required:!0,message:(0,c.t)("Title is required"),whitespace:!0}]},(0,x.tZ)(B.II,null)),(0,x.tZ)(At.xJ,{initialValue:n?n.description:"",label:(0,c.t)("Description"),name:["filters",t,"description"]},(0,x.tZ)(B.Kx,{rows:4})),(0,x.tZ)(At.xJ,{hidden:!0,name:["filters",t,"type"],initialValue:no.BE.DIVIDER}))},ac=(0,y.iK)(Rn.o)`
  min-width: 700px;
  .ant-modal-body {
    padding: 0px;
  }
...
`,lc=(0,y.iK)(H.qz)`
  width: 100%;
`,dc=ys("filters-config-modal"),cc=["filter_range","filter_select","filter_time"],uc=[],hc={},pc={filters:{}};function mc(e){let{isOpen:t,initialFilterId:n,createNewOnOpen:i,onSave:o,onCancel:l}=e;const d=(0,r.I0)(),[u]=H.qz.useForm(),h=(0,s.useRef)(),p=js(),m=function(){const e=js();return(0,s.useMemo)((()=>e.reduce(((e,t)=>(e[t.id]=t,e)),{})),[e])}(),[g,f]=(0,s.useState)(uc),[v,b]=(0,s.useState)(hc),[y,S]=(0,s.useState)(!1),C=(0,s.useMemo)((()=>Ul()([...(0,ws.QN)(p),...g]).filter((e=>{var t;return!v[e]||(null==(t=v[e])?void 0:t.isPending)}))),[p,g,v]),w=null!=n?n:C[0],[R,k]=(0,s.useState)(w),[T,$]=(0,s.useState)(uc),[D,I]=(0,s.useState)(pc),F=g.filter((e=>!v[e])),M=(0,s.useCallback)((e=>{const t=v[e];null!=t&&t.isPending&&clearTimeout(t.timerId),b((t=>({...t,[e]:null})))}),[v]),E=(0,s.useMemo)((()=>Object.keys(m)),[m]),[O,z]=(0,s.useState)(E),[U,P]=(0,s.useState)([w]),N=e=>[`${e}-${Yd.configuration.key}`,`${e}-${Yd.settings.key}`],[A,q]=(0,s.useState)(N(w)),L=(0,s.useCallback)((e=>{const t=(0,ws.W6)(e);f([...g,t]),k(t),S(!1),z([...O,t]),q(N(t))}),[g,O,k,z,f]);((e,t,n)=>{const i=(0,Pr.D)(e);(0,s.useEffect)((()=>{n&&e&&!i&&t(no.BE.NATIVE_FILTER)}),[n,e,i,t])})(t,L,i),((e,t,n,i)=>{(0,s.useEffect)((()=>{const r=e[t];if(r&&!r.isPending){const r=n.flat().find((n=>!e[n]&&n!==t));r&&i(r)}}),[t,e,n,i])})(v,R,O,k);const j=(0,ws.EJ)(b,z,S),V=function(e){void 0===e&&(e=!1),f(uc),k(w),b(hc),S(!1),I(pc),$(uc),C.length>0&&q(N(C[0])),e||z(E),P([w]),u.resetFields(["filters"]),u.setFieldsValue({changed:!1})},K=(0,s.useCallback)((e=>{const t=D.filters[e],n=m[e];return t&&"name"in t&&t.name||t&&"title"in t&&t.title||n&&"name"in n&&n.name||n&&"title"in n&&n.title||(0,c.t)("[untitled]")}),[m,D.filters]),B=(0,s.useCallback)((e=>{var t;if(v[e])return!1;const n=(null==(t=u.getFieldValue("filters"))?void 0:t[e])||m[e];return n&&"filterType"in n&&a()(cc).call(cc,n.filterType)}),[m,u,v]),W=(0,s.useCallback)((e=>C.filter((t=>t!==e)).filter((e=>B(e))).map((e=>{var t;return{label:K(e),value:e,type:null==(t=m[e])?void 0:t.filterType}}))),[B,C,K]),Y=(0,s.useCallback)((()=>{const e=u.getFieldsError(),t=[];e.forEach((e=>{const n=e.name[1];e.errors.length>0&&!a()(t).call(t,n)&&t.push(n)})),!t.length&&T.length>0?$(uc):t.length>0&&!mi()(Ol()(T),Ol()(t))&&$(t)}),[u,T]),J=async()=>{const e=await(0,ws.G$)(u,R,k);Y(),e?((e=>{Object.keys(m).forEach((e=>{const t=m[e];if(!("cascadeParentIds"in t))return;const{cascadeParentIds:n}=t;n&&d((0,al.rF)(e,n.filter((e=>B(e)))))}));const t=null==e?void 0:e.filters;t&&Object.keys(t).forEach((e=>{const n=t[e];if(!("dependencies"in n))return;const{dependencies:i}=n;i&&(n.dependencies=i.filter((e=>B(e))))}))})(e),(0,ws.GA)(m,O,v,o,e)(),V(!0)):h.current.changeTab("configuration")},X=()=>{V(),l()},G=()=>{const e=u.getFieldValue("changed"),t=O.length!==E.length||O.some(((e,t)=>e!==E[t]));F.length>0||u.isFieldsTouched()||e||t?S(!0):X()},Q=(0,s.useCallback)((()=>{const e=new Map,t=u.getFieldValue("filters");return t&&Object.keys(t).forEach((n=>{const i=t[n],r=m[n];let o=[];i&&"dependencies"in i?o=[...i.dependencies]:null!=r&&r.cascadeParentIds&&(o=[...r.cascadeParentIds]),e.set(n,o)})),e}),[m,u]),ee=(0,s.useCallback)((()=>{const e=Q();C.filter((e=>!v[e])).forEach((t=>{const n={name:["filters",t,"dependencies"],errors:(0,ws.uh)(e,t)?[(0,c.t)("Cyclic dependency detected")]:[]};u.setFields([n])})),Y()}),[Q,C,u,Y,v]),te=(0,s.useCallback)((e=>{const t=Q(),n=O.filter((t=>t!==e&&B(t)));return n.find((n=>{const i=t.get(e)||[];return i.push(n),!(0,ws.uh)(t,e)||(i.pop(),!1)}))||n[0]}),[Q,B,O]),ne=(0,s.useMemo)((()=>_()(((e,t)=>{const n=e.filters&&Object.values(e.filters).some((e=>e.name&&null!==e.name)),i=e.filters&&Object.values(e.filters).some((e=>e.title&&null!==e.title));(n||i)&&I(t),S(!1),Y()}),gs.M)),[Y]);(0,s.useEffect)((()=>{wt()(v)||$((e=>e.filter((e=>!v[e]))))}),[v]),(0,s.useEffect)((()=>{a()(U).call(U,R)||P([...U,R])}),[R]);const ie=(0,s.useCallback)((e=>q(e)),[q]),re=(0,s.useMemo)((()=>O.map((e=>{if(!a()(U).call(U,e))return null;const t=e.startsWith(ws.Ky),n=R===e;return(0,x.tZ)("div",{key:e,style:{height:"100%",overflowY:"auto",display:n?"":"none"}},t?(0,x.tZ)(oc,{componentId:e,divider:m[e]}):(0,x.tZ)(Qd,{ref:h,form:u,filterId:e,filterToEdit:m[e],removedFilters:v,restoreFilter:M,getAvailableFilters:W,key:e,activeFilterPanelKeys:A,handleActiveFilterPanelChange:ie,isActive:n,setErroredFilters:$,validateDependencies:ee,getDependencySuggestion:te}))}))),[U,O,R,m,u,v,M,W,A,ee,te,ie]);return(0,x.tZ)(ac,{visible:t,maskClosable:!1,title:(0,c.t)("Add and edit filters"),width:"50%",destroyOnClose:!0,onCancel:G,onOk:J,centered:!0,footer:(0,x.tZ)(ic,{onDismiss:()=>S(!1),onCancel:G,handleSave:J,canSave:!T.length,saveAlertVisible:y,onConfirmCancel:X})},(0,x.tZ)(Z.Z,null,(0,x.tZ)(sc,null,(0,x.tZ)(lc,{form:u,onValuesChange:ne,layout:"vertical"},(0,x.tZ)(Kl,{erroredFilters:T,onRemove:j,onAdd:L,onChange:e=>{k(e),q(N(e))},getFilterTitle:K,currentFilterId:R,removedFilters:v,restoreFilter:M,onRearrange:(e,t)=>{const n=[...O],i=n.splice(e,1)[0];n.splice(t,0,i),z(n)},filters:O},re)))))}const gc=s.memo(mc),fc=(0,y.iK)(W.Z)`
  padding: 0;
`,vc=e=>{let{createNewOnOpen:t,dashboardId:n,initialFilterId:i,onClick:o,children:a}=e;const l=(0,r.I0)(),[d,c]=(0,s.useState)(!1),u=(0,s.useCallback)((()=>{c(!1)}),[c]),h=(0,s.useCallback)((async e=>{l(await(0,al.RY)(e)),u()}),[l,u]),p=(0,s.useCallback)((()=>{c(!0),o&&o()}),[c,o]);return(0,x.tZ)(s.Fragment,null,(0,x.tZ)(fc,ne()({},Zs("create-filter"),{buttonStyle:"link",buttonSize:"xsmall",onClick:p}),a),(0,x.tZ)(gc,{isOpen:d,onSave:h,onCancel:u,initialFilterId:i,createNewOnOpen:t,key:`filters-for-${n}`}))},bc=s.memo(vc),yc=e=>{let{filter:t,hidePopover:n}=e;const i=(0,y.Fg)(),o=(0,s.useRef)(null),[a]=(0,fl.Z)(o),l=(0,r.v9)((e=>{let{dashboardInfo:t}=e;return t.id})),d=(0,r.v9)((e=>{let{dashboardInfo:t}=e;return t.dash_edit_perm}));return(0,x.tZ)(yl,{css:e=>x.iv`
        margin-bottom: ${3*e.gridUnit}px;
        justify-content: space-between;
      `},(0,x.tZ)($l,null,(0,x.tZ)(Y.Z.FilterSmall,{css:e=>x.iv`
            margin-right: ${e.gridUnit}px;
          `}),(0,x.tZ)(Dl,{title:a?t.name:null},(0,x.tZ)(Cl,{ref:o},t.name))),d&&(0,x.tZ)(vc,{dashboardId:l,onClick:n,initialFilterId:t.id},(0,x.tZ)(Y.Z.Edit,{iconSize:"l",iconColor:i.colors.grayscale.light1})))},xc=e=>{let{filter:t}=e;const n=(0,s.useMemo)((()=>(0,Zi.Z)().get(t.filterType)),[t.filterType]);return(0,x.tZ)(yl,null,(0,x.tZ)(xl,null,(0,c.t)("Filter type")),(0,x.tZ)(Sl,null,null==n?void 0:n.name))},Sc=e=>{let{filter:t,hidePopover:n}=e;return(0,x.tZ)("div",null,(0,x.tZ)(yc,{filter:t,hidePopover:n}),(0,x.tZ)(xc,{filter:t}),(0,x.tZ)(Il,{filter:t}),(0,x.tZ)(Ml,{filter:t}))},Cc=e=>{let{children:t,filter:n,getPopupContainer:i,isVisible:r=!0,placement:o}=e;const[a,l]=(0,s.useState)(!1);return(0,s.useEffect)((()=>{r||l(!1)}),[r]),(0,x.tZ)(ri.Z,{placement:o,overlayClassName:"filter-card-popover",mouseEnterDelay:.2,mouseLeaveDelay:.2,onVisibleChange:e=>{l(r&&e)},visible:r&&a,content:(0,x.tZ)(Sc,{filter:n,hidePopover:()=>{l(!1)}}),getPopupContainer:null!=i?i:()=>document.body},t)};var Zc;!function(e){e.AllFilters="allFilters",e.FilterSets="filterSets"}(Zc||(Zc={}));const wc=(e,t)=>{const n=Rs(),i=Object.values(n),r=(0,s.useMemo)((()=>!!i.find((t=>{let{name:n}=t;return n===e}))),[i,e]);return t!==e&&r},Rc=y.iK.div`
  display: flex;
  & button {
...
`,Tc=e=>{let{onCancel:t,editMode:n,onEdit:i,onCreate:r,disabled:o,filterSetName:a}=e;const l=wc(a),d=!a||l||o;return(0,x.tZ)(s.Fragment,null,n?(0,x.tZ)(kc,null,(0,x.tZ)(W.Z,{buttonStyle:"tertiary",buttonSize:"small",onClick:t},(0,c.t)("Cancel")),(0,x.tZ)(re.u,{placement:"right",title:!a&&(0,c.t)("Please filter set name")||l&&(0,c.t)("Filter set with this name already exists")||o&&Hr},(0,x.tZ)(Rc,{disabled:d},(0,x.tZ)(W.Z,ne()({disabled:d,buttonStyle:"primary",htmlType:"submit",buttonSize:"small",onClick:r},Zs("create-filter-set-button")),(0,c.t)("Create"))))):(0,x.tZ)(re.u,{placement:"bottom",title:o&&Hr},(0,x.tZ)(Rc,{disabled:o},(0,x.tZ)(W.Z,ne()({disabled:o,buttonStyle:"tertiary",buttonSize:"small",onClick:i},Zs("new-filter-set-button")),(0,c.t)("Create new filter set")))))},$c=y.iK.div`
  display: flex;
  align-items: center;
  font-size: ${e=>{let{theme:t}=e;return t.typography.sizes.s}}px;
`,Dc=(0,y.iK)(H.Ol)`
...
`,_c=y.iK.div`
  padding-top: ${e=>{let{theme:t}=e;return t.gridUnit}}px;
  padding-bottom: ${e=>{let{theme:t}=e;return t.gridUnit}}px;
`,Ic=e=>{let{dataMask:t,filterSet:n}=e;const i=(0,y.Fg)(),r=ks(),o=Object.values(r).filter(no.kI);let s=null!=o?o:[];return null!=n&&n.nativeFilters&&(s=Object.values(null==n?void 0:n.nativeFilters).filter(no.kI)),(0,x.tZ)(Dc,{ghost:!0,expandIconPosition:"right",defaultActiveKey:n?void 0:["filters"],expandIcon:e=>{let{isActive:t}=e;const n=i.colors.grayscale.base,r=t?Y.Z.CaretUpOutlined:Y.Z.CaretDownOutlined;return(0,x.tZ)(r,{iconColor:n})}},(0,x.tZ)(H.Ol.Panel,ne()({},Zs("collapse-filter-set-description"),{header:(0,x.tZ)($c,null,(0,x.tZ)(H.ZT.Text,{type:"secondary"},(0,c.t)("Filters (%d)",s.length))),key:"filters"}),s.map((e=>{var i,o,s,l,d,u;let{id:h,name:p}=e;const m=n&&!(0,bi.JB)(null==(i=r[h])?void 0:i.controlValues,null==n||null==(o=n.nativeFilters)||null==(s=o[h])?void 0:s.controlValues,{ignoreUndefined:!0}),g=!a()(l=Object.keys(r)).call(l,h);return(0,x.tZ)(H._e,{title:g&&(0,c.t)("This filter doesn't exist in dashboard. It will not be applied.")||m&&(0,c.t)("Filter metadata changed in dashboard. It will not be applied."),placement:"bottomLeft",key:h},(0,x.tZ)(_c,null,(0,x.tZ)(H.ZT.Text,{strong:!0,delete:g,mark:m},p,": "),(0,x.tZ)(H.ZT.Text,{delete:g,mark:m},Wr(null==t||null==(d=t[h])||null==(u=d.filterState)?void 0:u.value)||(0,x.tZ)(H.ZT.Text,{type:"secondary"},(0,c.t)("None")))))}))))},Fc=(0,y.iK)(W.Z)`
  padding: 0;
`,Mc=y.iK.div`
  display: flex;
  justify-content: space-between;
...
`,Oc=e=>{var t,n;let{editMode:i,setFilterSetName:r,onDelete:o,onEdit:a,filterSetName:l,dataMaskSelected:d,filterSet:u,isApplied:h,onRebuild:p}=e;const m=(0,y.Fg)(),g=(0,x.tZ)(kt.v,null,(0,x.tZ)(kt.v.Item,{onClick:a},(0,c.t)("Edit")),(0,x.tZ)(kt.v.Item,{onClick:p},(0,x.tZ)(re.u,{placement:"right",title:(0,c.t)("Remove invalid filters")},(0,c.t)("Rebuild"))),(0,x.tZ)(kt.v.Item,{onClick:o,danger:!0},(0,c.t)("Delete")));return(0,x.tZ)(s.Fragment,null,(0,x.tZ)(Mc,null,(0,x.tZ)(H.ZT.Text,{strong:!0,editable:{editing:i,icon:(0,x.tZ)("span",null),onChange:r}},null!=(t=null==u?void 0:u.name)?t:l),(0,x.tZ)(Ec,null,h&&(0,x.tZ)(Y.Z.CheckOutlined,{iconSize:"m",iconColor:m.colors.success.base}),o&&(0,x.tZ)(H.Gj,{overlay:g,placement:"bottomRight",trigger:["click"]},(0,x.tZ)(Fc,ne()({onClick:e=>{e.stopPropagation(),e.preventDefault()}},Zs("filter-set-menu-button"),{buttonStyle:"link",buttonSize:"xsmall"}),(0,x.tZ)(Y.Z.EllipsisOutlined,{iconSize:"m"}))))),(0,x.tZ)(Ic,{filterSet:u,dataMask:null!=(n=null==u?void 0:u.dataMask)?n:d}))},zc=y.iK.div`
  display: grid;
  align-items: center;
  justify-content: center;
...
`,Pc=(0,c.t)("New filter set"),Nc=e=>{let{dataMaskSelected:t,onEditFilterSet:n,disabled:i,onFilterSelectionChange:o,tab:a}=e;const l=(0,r.I0)(),[d,c]=(0,s.useState)(Pc),[u,h]=(0,s.useState)(!1),p=Ts(),m=Rs(),g=Object.values(m),f=ks(),v=Object.values(f),[b,y]=(0,s.useState)(null);(0,s.useEffect)((()=>{var e;if(a===Zc.AllFilters)return;if(!g.length)return void y(null);const n=Yr({dataMaskSelected:t,filterSetFilterValues:g});y(null!=(e=null==n?void 0:n.id)?e:null)}),[a,t,g]);const S=(e,t)=>{var n,i,r;return!v.find((t=>(null==t?void 0:t.id)===e))||!(0,bi.JB)(null==(n=f[e])?void 0:n.controlValues,null==t||null==(i=t.nativeFilters)||null==(r=i[e])?void 0:r.controlValues,{ignoreUndefined:!0})},C=(e,t)=>{var n;const i=null==t?void 0:t.target;if(i){var r;const e=i.closest(`[data-anchor=${Zs("filter-set-wrapper",!0)}]`);if(null!=e&&null!=(r=e.querySelector(".ant-collapse-header"))&&r.contains(i)||null!=i&&i.closest(".ant-dropdown"))return}if(y(e),!e)return;const a=m[e];(null!=(n=Object.values(null==a?void 0:a.dataMask))?n:[]).forEach((e=>{const{extraFormData:t,filterState:n,id:i}=e;S(i,a)||o({id:i},{extraFormData:t,filterState:n})}))};return(0,x.tZ)(zc,null,!b&&(0,x.tZ)(Uc,null,(0,x.tZ)(Oc,{dataMaskSelected:t,editMode:u,setFilterSetName:c,filterSetName:d}),(0,x.tZ)(Tc,{filterSetName:d.trim(),disabled:i,onCancel:()=>{h(!1),c(Pc)},editMode:u,onEdit:()=>h(!0),onCreate:()=>{const e={name:d.trim(),nativeFilters:f,dataMask:Object.keys(f).reduce(((e,t)=>({...e,[t]:p[t]})),{})};l((0,al.xQ)(e)),h(!1),c(Pc)}})),g.map((e=>(0,x.tZ)(Uc,ne()({},Zs("filter-set-wrapper"),{"data-anchor":Zs("filter-set-wrapper",!0),"data-selected":e.id===b,onClick:t=>C(e.id,t),key:e.id}),(0,x.tZ)(Oc,{isApplied:e.id===b&&!i,onDelete:()=>{return t=e.id,l((0,al.$l)(t)),void(t===b&&y(null));var t},onEdit:()=>{return t=e.id,C(t),void n(t);var t},onRebuild:()=>(e=>{var t;const n=m[e],i=Object.values(null!=(t=null==n?void 0:n.dataMask)?t:{}).filter((e=>{const{id:t}=e;return!S(t,n)})).reduce(((e,t)=>({...e,[t.id]:f[t.id]})),{}),r={...n,nativeFilters:i,dataMask:Object.keys(i).reduce(((e,t)=>{var i;return{...e,[t]:null==(i=n.dataMask)?void 0:i[t]}}),{})};l((0,al.ql)(r))})(e.id),dataMaskSelected:t,filterSet:e})))))},Ac=y.iK.div`
  display: grid;
  grid-template-columns: 1fr;
  align-items: flex-start;
  justify-content: flex-start;
...
`,Vc=e=>{let{filterSetId:t,onCancel:n,dataMaskSelected:i,disabled:o}=e;const a=Ts(),l=(0,r.I0)(),d=Rs(),u=ks(),h=Object.values(d),[p,m]=(0,s.useState)(d[t].name),g=wc(p,d[t].name),f=(0,s.useMemo)((()=>Yr({dataMaskSelected:i,filterSetFilterValues:h})),[i,h]),v=f&&f.id!==t,b=o||v||g;return(0,x.tZ)(Ac,null,(0,x.tZ)(qc,{strong:!0},(0,c.t)("Editing filter set:")),(0,x.tZ)(qc,{editable:{editing:!0,icon:(0,x.tZ)("span",null),onChange:m}},p),(0,x.tZ)(kc,null,(0,x.tZ)(W.Z,{ghost:!0,buttonStyle:"tertiary",buttonSize:"small",onClick:n},(0,c.t)("Cancel")),(0,x.tZ)(H._e,{placement:"right",title:g&&(0,c.t)("Filter set with this name already exists")||v&&(0,c.t)("Filter set already exists")||o&&Hr},(0,x.tZ)(jc,{disabled:b},(0,x.tZ)(W.Z,ne()({disabled:b,buttonStyle:"primary",htmlType:"submit",buttonSize:"small",onClick:()=>{l((0,al.ql)({id:t,name:p,nativeFilters:u,dataMask:{...a}})),n()}},Zs("filter-set-edit-save")),(0,c.t)("Save"))))),v&&(0,x.tZ)(Lc,{mark:!0},(0,x.tZ)(Y.Z.WarningOutlined,{iconSize:"m"}),(0,c.t)('This filter set is identical to: "%s"',null==f?void 0:f.name)))};var Kc=n(21804),Bc=n.n(Kc);const Hc=y.iK.div`
  .ant-btn-group {
    button.ant-btn {
...
`,{SubMenu:Wc}=kt.v,Yc=(0,y.iK)((e=>{let{overlay:t,tooltip:n,placement:i,...r}=e;const o=function(e){return void 0===e&&(e={}),(0,x.tZ)(Hc,null,(0,x.tZ)(H.Gj.Button,ne()({overlay:t},r,e)))};return n?o({buttonsRender:e=>{let[t,r]=e;return[(0,x.tZ)(H._e,{placement:i,id:`${Bc()(n)}-tooltip`,title:n},t),r]}}):o()}))`
...
`,Qc=e=>{const t=(0,y.Fg)(),{icon:n,info:i,menuItems:r,selectedKeys:o,onSelect:l}=e,d=(0,s.useMemo)((()=>(e,n,i)=>(0,x.tZ)(Xc,{key:n,divider:i},(0,x.tZ)(Gc,null,(0,x.tZ)("span",null,e),(null==o?void 0:a()(o).call(o,n))&&(0,x.tZ)(Y.Z.Check,{iconColor:t.colors.primary.base,className:"tick-menu-item",iconSize:"xl"})))),[o,t.colors.primary.base]),c=(0,s.useMemo)((()=>(0,x.tZ)(Jc,{selectedKeys:o,onSelect:l,selectable:!0},i&&(0,x.tZ)("div",{className:"info"},i),r.map((e=>{var t;return null!=(t=e.children)&&t.length?(0,x.tZ)(Wc,{title:e.label,key:e.key},e.children.map((e=>d(e.label,e.key)))):d(e.label,e.key,e.divider)})))),[o,l,i,r,d]);return(0,x.tZ)(Yc,{overlay:c,trigger:["click"],icon:n})},eu=y.iK.span`
  display: flex;
  align-items: center;
  justify-content: space-between;
...
`,nu="cross-filters-menu-key",iu="cross-filters-scoping-menu-key",ru=()=>{const e=(0,r.I0)(),t=(0,y.Fg)(),n=(0,r.v9)((e=>{let{dashboardInfo:t}=e;return t.crossFiltersEnabled})),i=(0,r.v9)((e=>{let{dashboardInfo:t}=e;return t.filterBarOrientation})),[o,a]=(0,s.useState)(i),l=(0,u.c)(u.T.DASHBOARD_CROSS_FILTERS),d=n&&l,[h,p]=(0,s.useState)(d),m=(0,r.v9)((e=>{let{dashboardInfo:t}=e;return t.dash_edit_perm})),g=m&&(0,u.c)(u.T.HORIZONTAL_FILTER_BAR),[f,v]=yr(),b=(0,s.useCallback)((async t=>{t||e((0,mt.sh)()),await e((0,Wn.C6)(t))}),[e]),S=(0,s.useCallback)((()=>{p(!h),b(!h)}),[h,b]),C=(0,s.useCallback)((async t=>{if(t!==i){a(t);try{await e((0,Wn.Mn)(t))}catch{a(i)}}}),[e,i]),Z=(0,s.useCallback)((e=>{const t=e.key;var n;t===nu?S():(n=t)===Fi.Bp.VERTICAL||n===Fi.Bp.HORIZONTAL?C(t):t===iu&&f()}),[f,S,C]),w=(0,s.useMemo)((()=>(0,x.tZ)(eu,null,(0,x.tZ)(tu,{className:"enable-cross-filters",checked:h,onChange:e=>p(e||!1)})," ",(0,x.tZ)("span",{className:"enable-cross-filters-text"},(0,c.t)("Enable cross-filtering")))),[h]),R=(0,s.useMemo)((()=>{const e=[];return l&&m&&(e.push({key:nu,label:w}),e.push({key:iu,label:(0,c.t)("Cross-filtering scoping"),divider:g})),g&&e.push({key:"placement",label:(0,c.t)("Orientation of filter bar"),children:[{key:Fi.Bp.VERTICAL,label:(0,c.t)("Vertical (Left)")},{key:Fi.Bp.HORIZONTAL,label:(0,c.t)("Horizontal (Top)")}]}),e}),[m,g,w,l]);return R.length?(0,x.tZ)(s.Fragment,null,(0,x.tZ)(Qc,{onSelect:Z,icon:(0,x.tZ)(Y.Z.Gear,{name:"gear",iconColor:t.colors.grayscale.base}),menuItems:R,selectedKeys:[o]}),v):null},ou=y.iK.div`
  ${e=>{let{theme:t}=e;return x.iv`
    display: flex;
    align-items: center;
    flex-direction: row;
...
`,lu=y.iK.div`
  ...
  `}}
`,du=e=>{let{toggleFiltersBar:t}=e;const n=(0,y.Fg)(),i=ks(),o=(0,s.useMemo)((()=>Object.values(i)),[i]),a=(0,r.v9)((e=>{let{dashboardInfo:t}=e;return t.dash_edit_perm})),l=(0,r.v9)((e=>{let{dashboardInfo:t}=e;return t.id}));return(0,x.tZ)(su,null,(0,x.tZ)(ou,null,(0,x.tZ)("span",null,(0,c.t)("Filters")),(0,x.tZ)(ru,null),(0,x.tZ)(au,ne()({},Zs("collapse-button"),{buttonStyle:"link",buttonSize:"xsmall",onClick:()=>t(!1)}),(0,x.tZ)(Y.Z.Expand,{iconColor:n.colors.grayscale.base}))),a&&(0,x.tZ)(lu,null,(0,x.tZ)(bc,{dashboardId:l,createNewOnOpen:0===o.length},(0,x.tZ)(Y.Z.PlusSmall,null)," ",(0,c.t)("Add/Edit Filters"))))},cu=s.memo(du),uu=e=>{const{dataMask:t,chartConfiguration:n,dashboardLayout:i,verboseMaps:r}=e;return Object.keys(n).map((e=>{const n=Number(e),o=co(n,t[n],i);if((0,Ii.Z)(o.column)&&(0,Ii.Z)(o.value)){var a;const e=(null==(a=r[n])?void 0:a[(0,to.Z)(o.column)])||o.column;return{...o,column:e,emitterId:n}}return null})).filter(Boolean)},hu=x.iv`
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
  display: inline-block;
...
`,fu=e=>{var t;const{filter:n,orientation:i,removeCrossFilter:r}=e,o=(0,y.Fg)(),[a,s]=(0,Js.Z)(),[l,d]=(0,Js.Z)(),c=(0,to.Z)(null!=(t=n.column)?t:"");return(0,x.tZ)(gu,{css:x.iv`
        ${i===Fi.Bp.VERTICAL?`\n            margin-top: ${2*o.gridUnit}px;\n          `:`\n            margin-left: ${2*o.gridUnit}px;\n          `}
      `,closable:!0,onClose:()=>r(n.emitterId)},(0,x.tZ)(re.u,{title:s?c:null},(0,x.tZ)(mu,{ref:a},c)),(0,x.tZ)(re.u,{title:d?n.value:null},(0,x.tZ)(pu,{ref:l},n.value)))},vu=y.iK.div`
  ${e=>{let{theme:t}=e;return`\n    display: flex;\n    font-size: ${t.typography.sizes.s}px;\n    color: ${t.colors.grayscale.base};\n    vertical-align: middle;\n    align-items: center;\n  `}}
`,bu=(0,y.iK)(Y.Z.SearchOutlined)`
  ${e=>{let{theme:t}=e;return`\n    & > span.anticon.anticon-search {\n      color: ${t.colors.grayscale.light1};\n      margin-left: ${t.gridUnit}px;\n      transition: 0.3s;\n      vertical-align: middle;\n      line-height: 0;\n      &:hover {\n        color: ${t.colors.grayscale.base};\n      }\n    }\n  `}}
`,yu=e=>{const{title:t,orientation:n,onHighlightFilterSource:i}=e,[r,o]=(0,Js.Z)(),a=(0,y.Fg)();return(0,x.tZ)(vu,null,(0,x.tZ)(re.u,{title:o?t:null},(0,x.tZ)("span",{css:x.iv`
            max-width: ${n===Fi.Bp.VERTICAL?45*a.gridUnit+"px":15*a.gridUnit+"px"};
            line-height: 1.4;
            ${hu}
          `,ref:r},t)),(0,x.tZ)(re.u,{title:(0,c.t)("Locate the chart")},(0,x.tZ)(bu,{iconSize:"s",role:"button",tabIndex:0,onClick:i})))},xu=e=>{const{filter:t,orientation:n,last:i}=e,o=(0,y.Fg)(),a=(0,r.I0)(),l=(0,s.useCallback)((e=>{e&&a((0,Yn.E2)(e))}),[a]);return(0,x.tZ)("div",{key:`${t.name}${t.emitterId}`,css:x.iv`
        ${n===Fi.Bp.VERTICAL?`\n            display: block;\n            margin-bottom: ${4*o.gridUnit}px;\n          `:"\n            display: flex;\n          "}
      `},(0,x.tZ)(yu,{title:t.name,orientation:n||Fi.Bp.HORIZONTAL,onHighlightFilterSource:()=>l(t.path)}),(t.column||t.value)&&(0,x.tZ)(fu,{filter:t,orientation:n,removeCrossFilter:e=>{a((0,mt.eG)(e,{extraFormData:{filters:[]},filterState:{value:null,selectedValues:null}}))}}),i&&(0,x.tZ)("span",{css:x.iv`
...
`,Cu=y.iK.span`
  ${e=>{let{theme:t}=e;return`\n    font-size: ${t.typography.sizes.s}px;\n  `}}
`,Zu=e=>{const{crossFilters:t}=e,n=(0,y.Fg)(),i=(0,s.useMemo)((()=>t.map((e=>(0,x.tZ)(xu,{key:e.emitterId,filter:e,orientation:Fi.Bp.VERTICAL})))),[t]);return t.length?(0,x.tZ)(Su,{ghost:!0,defaultActiveKey:"crossFilters",expandIconPosition:"right"},(0,x.tZ)(Yl.Z.Panel,{key:"crossFilters",header:(0,x.tZ)(Cu,null,(0,c.t)("Cross-filters"))},i,(0,x.tZ)("span",{css:x.iv`
            width: 100%;
            height: 1px;
            display: block;
            background: ${n.colors.grayscale.light3};
            margin: ${8*n.gridUnit}px auto 0 auto;
          `}))):null},wu=()=>{const e=(0,r.v9)((e=>e.dataMask)),t=(0,r.v9)((e=>{var t;return null==(t=e.dashboardInfo.metadata)?void 0:t.chart_configuration})),n=(0,r.v9)((e=>e.dashboardLayout.present)),i=Cs(),o=uu({dataMask:e,chartConfiguration:t,dashboardLayout:n,verboseMaps:i});return(0,x.tZ)(Zu,{crossFilters:o})},Ru=y.iK.div`
...
`,$u=(0,y.iK)(Y.Z.Collapse)`
  ${e=>{let{theme:t}=e;return`\n    color: ${t.colors.primary.base};\n    margin-bottom: ${3*t.gridUnit}px;\n  `}}
`,Du=(0,y.iK)(Y.Z.Filter)`
  color: ${e=>{let{theme:t}=e;return t.colors.grayscale.base}};
`,_u=(0,y.iK)(H.D6)`
  & .ant-tabs-nav-list {
    width: 100%;
...
`,Fu=y.iK.div`
  ...
  // 108px padding to make room for buttons with position: absolute
  padding-bottom: ${e=>{let{theme:t}=e;return 27*t.gridUnit}}px;
`,Mu=(0,s.createContext)(!1),Eu=e=>{let{actions:t,canEdit:n,dataMaskSelected:i,filtersOpen:r,filterValues:o,height:a,isDisabled:l,isInitialized:d,offset:h,onSelectionChange:m,toggleFiltersBar:g,width:f}=e;const[v,y]=(0,s.useState)(null),S=Rs(),C=Object.values(S),[Z,w]=(0,s.useState)(Zc.AllFilters),R=o.filter(no.kI),[k,T]=(0,s.useState)(!1),$=(0,s.useRef)(),D=(0,s.useCallback)((()=>g(!0)),[g]),_=(0,s.useMemo)((()=>be()((()=>{clearTimeout($.current),T(!0),$.current=setTimeout((()=>{T(!1)}),300)}),200)),[]);(0,s.useEffect)((()=>(document.onscroll=_,()=>{document.onscroll=null})),[_]);const I=(0,s.useMemo)((()=>({overflow:"auto",height:a,overscrollBehavior:"contain"})),[a]),F=R.length,M=(0,s.useMemo)((()=>0===o.length?(0,x.tZ)(Iu,null,(0,x.tZ)(Ba.Tc,{title:(0,c.t)("No global filters are currently added"),image:"filter.svg",description:n&&(0,c.t)('Click on "+Add/Edit Filters" button to create new dashboard filters')})):(0,x.tZ)(Fu,null,(0,x.tZ)(sh,{dataMaskSelected:i,onFilterSelectionChange:m}))),[n,i,o.length,m]),E=(0,s.useMemo)((()=>(0,x.tZ)(_u,{centered:!0,onChange:w,defaultActiveKey:Zc.AllFilters,activeKey:v?Zc.AllFilters:void 0},(0,x.tZ)(H.D6.TabPane,{tab:(0,c.t)("All filters (%(filterCount)d)",{filterCount:F}),key:Zc.AllFilters,css:I},v&&(0,x.tZ)(Vc,{dataMaskSelected:i,disabled:!l,onCancel:()=>y(null),filterSetId:v}),M),(0,x.tZ)(H.D6.TabPane,{disabled:!!v,tab:(0,c.t)("Filter sets (%(filterSetCount)d)",{filterSetCount:C.length}),key:Zc.FilterSets,css:I},(0,x.tZ)(Nc,{onEditFilterSet:y,disabled:!l,dataMaskSelected:i,tab:Z,onFilterSelectionChange:m})))),[i,v,M,C.length,l,F,m,Z,I]),O=(0,s.useMemo)((()=>(0,yt.c)(u.T.DASHBOARD_CROSS_FILTERS)?(0,x.tZ)(wu,null):null),[]);return(0,x.tZ)(Mu.Provider,{value:k},(0,x.tZ)(Ru,ne()({},Zs(),{className:b()({open:r}),width:f}),(0,x.tZ)(Tu,ne()({},Zs("collapsable"),{className:b()({open:!r}),onClick:D,offset:h}),(0,x.tZ)($u,ne()({},Zs("expand-button"),{iconSize:"l"})),(0,x.tZ)(Du,ne()({},Zs("filter-icon"),{iconSize:"l"}))),(0,x.tZ)(ku,{className:b()({open:r}),width:f},(0,x.tZ)(cu,{toggleFiltersBar:g}),d?(0,yt.c)(u.T.DASHBOARD_NATIVE_FILTERS_SET)?(0,x.tZ)(s.Fragment,null,O,E):(0,x.tZ)("div",{css:I,onScroll:_},(0,x.tZ)(s.Fragment,null,O,M)):(0,x.tZ)("div",{css:(0,x.iv)({height:a},"","")},(0,x.tZ)(p.Z,null)),t)))},Ou=s.memo(Eu);var zu;!function(e){e.Right="right",e.Bottom="bottom",e.Left="left"}(zu||(zu={}));const Uu=y.iK.div`
  position: absolute;
  right: 0;
`,Pu=y.iK.h4`
  font-size: ${e=>{let{theme:t}=e;return t.typography.sizes.s}}px;
...
`,Yu=Hu,Ju=y.iK.div`
  ...
  display: flex;
`,Xu=()=>(0,x.tZ)("span",{css:e=>({color:e.colors.error.base,fontSize:`${e.typography.sizes.s}px`,paddingLeft:"1px"})},"*"),Gu=e=>{let{description:t}=e;return(0,x.tZ)(Ju,null,(0,x.tZ)(re.u,{title:t,placement:"right",overlayInnerStyle:{display:"-webkit-box",overflow:"hidden",WebkitLineClamp:20,WebkitBoxOrient:"vertical",textOverflow:"ellipsis"}},(0,x.tZ)("i",{className:"fa fa-info-circle text-muted",css:e=>({paddingLeft:`${e.gridUnit}px`,cursor:"pointer"})})))},Qu=e=>{var t,n,i;let{dataMaskSelected:r,filter:o,icon:a,onFilterSelectionChange:l,inView:d,showOverflow:c,parentRef:u,orientation:h=Fi.Bp.VERTICAL,overflow:p=!1}=e;const m=(0,s.useMemo)((()=>qs()),[]),[g,f]=(0,s.useState)(!1),{name:v="<undefined>"}=o,b=Ss(o,null==(t=o.dataMask)?void 0:t.filterState),y=!(null==(n=o.controlValues)||!n.enableEmptyFilter),{FilterControlContainer:S,FormItem:C,FilterControlTitleBox:Z,FilterControlTitle:w}=((e,t)=>(0,s.useMemo)((()=>e===Fi.Bp.HORIZONTAL?t?{FilterControlContainer:Bu,FormItem:Yu,FilterControlTitleBox:ju,FilterControlTitle:Au}:{FilterControlContainer:Ku,FormItem:Wu,FilterControlTitleBox:Lu,FilterControlTitle:Nu}:{FilterControlContainer:Vu,FormItem:Hu,FilterControlTitleBox:qu,FilterControlTitle:Pu}),[e,t]))(h,p),R=(0,s.useMemo)((()=>{var e;return(0,x.tZ)(Z,null,(0,x.tZ)(w,null,v),y&&(0,x.tZ)(Xu,null),(null==(e=o.description)?void 0:e.trim())&&(0,x.tZ)(Gu,{description:o.description}),(0,x.tZ)(Uu,null,a))}),[Z,w,v,y,o.description,a]),k=(0,s.useContext)(Mu),T=(0,s.useMemo)((()=>h===Fi.Bp.HORIZONTAL?p?zu.Left:zu.Bottom:zu.Right),[h,p]);return(0,x.tZ)(s.Fragment,null,(0,x.tZ)(Ns,{node:m},(0,x.tZ)(gl,{dataMaskSelected:r,filter:o,showOverflow:c,onFilterSelectionChange:l,inView:d,parentRef:u,setFilterActive:f,orientation:h,overflow:p})),(0,x.tZ)(S,{layout:h!==Fi.Bp.HORIZONTAL||p?"vertical":"horizontal"},(0,x.tZ)(Cc,{filter:o,isVisible:!g&&!k,placement:T},(0,x.tZ)("div",null,(0,x.tZ)(C,{label:R,required:null==o||null==(i=o.controlValues)?void 0:i.enableEmptyFilter,validateStatus:b?"error":void 0},(0,x.tZ)(As,{node:m}))))))},eh=s.memo(Qu),th=e=>{let{title:t,description:n}=e;return(0,x.tZ)("div",null,(0,x.tZ)("h3",null,t),n?(0,x.tZ)("p",null,n):null)},nh=e=>{let{title:t,description:n}=e;const i=(0,y.Fg)(),[r,o]=(0,Js.Z)();return(0,x.tZ)("div",{css:x.iv`
        display: flex;
        align-items: center;
      ...
      `},(0,x.tZ)(re.u,{overlay:o?t:null},(0,x.tZ)("h3",{ref:r,css:x.iv`
          ...
          `},t)),n?(0,x.tZ)(re.u,{overlay:n},(0,x.tZ)(Y.Z.BookOutlined,{iconSize:"l",iconColor:i.colors.grayscale.base,css:x.iv`
              ...
              line-height: unset;
            `})):null)},ih=e=>{let{title:t,description:n}=e;const i=(0,y.Fg)(),[r,o]=(0,Js.Z)(),[a,s]=(0,Js.Z)();return(0,x.tZ)("div",{css:x.iv`
      ...
      `},(0,x.tZ)(re.u,{overlay:o?(0,x.tZ)("strong",null,t):null},(0,x.tZ)("h3",{ref:r,css:x.iv`
          ...
          `},t)),n?(0,x.tZ)(re.u,{overlay:s?n:null},(0,x.tZ)("p",{ref:a,css:x.iv`
            ...
            `},n)):null)},rh=e=>{let{title:t,description:n,orientation:i=Fi.Bp.VERTICAL,overflow:r=!1}=e;return i===Fi.Bp.HORIZONTAL?r?(0,x.tZ)(ih,{title:t,description:n}):(0,x.tZ)(nh,{title:t,description:n}):(0,x.tZ)(th,{title:t,description:n})},oh=e=>{let{overflowedCrossFilters:t,filtersInScope:n,filtersOutOfScope:i,renderer:r,rendererCrossFilter:o,showCollapsePanel:a,forceRenderOutOfScope:s}=e;return(0,x.tZ)("div",{css:e=>x.iv`
      width: ${56*e.gridUnit}px;
      padding: ${e.gridUnit}px 0;
    `},t.map((e=>o(e,Fi.Bp.VERTICAL,t.at(-1)))),n.map(r),a&&(0,x.tZ)(Ys,{filtersOutOfScope:i,renderer:r,forceRender:s,horizontalOverflow:!0}))},ah=e=>{let{dataMaskSelected:t,onFilterSelectionChange:n}=e;const i=(0,r.v9)((e=>{let{dashboardInfo:t}=e;return(0,u.c)(u.T.HORIZONTAL_FILTER_BAR)?t.filterBarOrientation:Fi.Bp.VERTICAL})),{outlinedFilterId:o,lastUpdated:l}=cl(),[d,h]=(0,s.useState)([]),p=(0,s.useRef)(null),m=(0,r.v9)((e=>e.dataMask)),f=(0,r.v9)((e=>{var t;return null==(t=e.dashboardInfo.metadata)?void 0:t.chart_configuration})),v=(0,r.v9)((e=>e.dashboardLayout.present)),b=Cs(),y=(0,u.c)(u.T.DASHBOARD_CROSS_FILTERS),S=(0,s.useMemo)((()=>y?uu({dataMask:m,chartConfiguration:f,dashboardLayout:v,verboseMaps:b}):[]),[f,v,m,y]),{filterControlFactory:C,filtersWithValues:Z}=((e,t)=>{const n=ks(),i=(0,s.useMemo)((()=>Object.values(n)),[n]),r=(0,s.useMemo)((()=>i.map((t=>({...t,dataMask:e[t.id]})))),[i,e]);return{filterControlFactory:(0,s.useCallback)(((n,i,o)=>{const a=r[n];return(0,no.nY)(a)?(0,x.tZ)(rh,{title:a.title,description:a.description,orientation:i,overflow:o}):(0,x.tZ)(eh,{dataMaskSelected:e,filter:a,onFilterSelectionChange:t,inView:!1,orientation:i,overflow:o})}),[r,e,t]),filtersWithValues:r}})(t,n),w=(0,s.useMemo)((()=>{const e=new Array(Z.length);for(let t=0;t<Z.length;t+=1)e[t]=qs();return e}),[Z.length]),R=new Set(Z.map((e=>e.id))),[k,T]=function(e){const t=Ks(),n=function(){const e=(0,r.v9)((e=>{var t;return null==(t=e.dashboardState)?void 0:t.activeTabs})),t=function(){const e=Vs();return t=>{const n=Object.values(e).find((e=>{var n;return(null==(n=e.meta)?void 0:n.chartId)===t}));return null==n?void 0:n.parents.filter((t=>e[t].type===g.gn))}}();return n=>{var i;return(0,no.nY)(n)||"chartsInScope"in n&&(null==(i=n.chartsInScope)?void 0:i.some((n=>{const i=t(n);return 0===(null==i?void 0:i.length)||(null==i?void 0:i.every((t=>a()(e).call(e,t))))})))}}();return(0,s.useMemo)((()=>{let i=[];const r=[];return t?e.forEach((e=>{n(e)?i.push(e):r.push(e)})):i=e,[i,r]}),[e,t,n])}(Z),$=(0,s.useMemo)((()=>Z.some((e=>e.requiredFirst))),[Z]),D=Ks()&&Z.length>0,_=(0,s.useCallback)(((e,t)=>{let{id:n}=e;const i=Z.findIndex((e=>e.id===n)),r=null!=t?t:n;return(0,x.tZ)(s.Fragment,{key:r},"",(0,x.tZ)(As,{node:w[i],inView:!0}))}),[Z,w]),I=(0,s.useMemo)((()=>k.filter((e=>{let{id:t}=e;return null==d?void 0:a()(d).call(d,t)}))),[k,d]),F=(0,s.useMemo)((()=>S.filter((e=>{let{emitterId:t,name:n}=e;return null==d?void 0:a()(d).call(d,`${n}${t}`)}))),[d,S]),M=(0,s.useMemo)((()=>[...I.filter((e=>(0,no.S0)(e))),...F]),[F,I]),E=(0,s.useCallback)(((e,t,n)=>(0,x.tZ)(xu,{filter:e,orientation:t,last:k.length>0&&`${n.name}${n.emitterId}`==`${e.name}${e.emitterId}`})),[k.length]),O=(0,s.useMemo)((()=>[...S.map((e=>({id:`${e.name}${e.emitterId}`,element:E(e,Fi.Bp.HORIZONTAL,S.at(-1))}))),...k.map(((e,t)=>({id:e.id,element:(0,x.tZ)("div",{className:"filter-item-wrapper",css:x.iv`
            flex-shrink: 0;
          `},_(e,t))})))]),[k,_,E,S]),z=(0,s.useMemo)((()=>{const e=new Set(T.map((e=>{let{id:t}=e;return t}))),t=new Set(I.map((e=>{let{id:t}=e;return t})));return Z.map((n=>e.has(n.id)||t.has(n.id)))}),[T,Z,I]);return(0,s.useEffect)((()=>{var e;o&&a()(d).call(d,o)&&(null==p||null==(e=p.current)||e.open())}),[o,l,p,d]),(0,x.tZ)(s.Fragment,null,w.filter(((e,t)=>R.has(Z[t].id))).map(((e,t)=>(0,x.tZ)(Ns,{node:e,key:Z[t].id},C(t,i,z[t])))),i===Fi.Bp.VERTICAL&&(0,x.tZ)(s.Fragment,null,k.map(_),D&&(0,x.tZ)(Ys,{filtersOutOfScope:T,forceRender:$,hasTopMargin:k.length>0,renderer:_})),i===Fi.Bp.HORIZONTAL&&(0,x.tZ)("div",{css:e=>x.iv`
        padding: 0 ${4*e.gridUnit}px;
        min-width: 0;
        flex: 1;
      `},(0,x.tZ)(Ws,{items:O,dropdownTriggerIcon:(0,x.tZ)(Y.Z.FilterSmall,{css:x.iv`
              && {
                margin-right: -4px;
                display: flex;
              }
            `}),dropdownTriggerText:(0,c.t)("More filters"),dropdownTriggerCount:M.length,dropdownTriggerTooltip:0===M.length?(0,c.t)("No applied filters"):(0,c.t)("Applied filters: %s",M.map((e=>e.name)).join(", ")),dropdownContent:I.length||F.length||T.length&&D?()=>(0,x.tZ)(oh,{overflowedCrossFilters:F,filtersInScope:I,filtersOutOfScope:T,renderer:_,rendererCrossFilter:E,showCollapsePanel:D,forceRenderOutOfScope:$}):void 0,forceRender:$,ref:p,onOverflowingStateChange:e=>{let{overflowed:t}=e;(t.length!==d.length||d.reduce(((e,n,i)=>e||n!==t[i]),!1))&&h(t)}})))},sh=s.memo(ah),lh=y.iK.div`
...
`,hh=e=>{let{actions:t,canEdit:n,dashboardId:i,dataMaskSelected:o,filterValues:a,isInitialized:l,onSelectionChange:d}=e;const h=(0,r.v9)((e=>e.dataMask)),m=(0,r.v9)((e=>{var t;return null==(t=e.dashboardInfo.metadata)?void 0:t.chart_configuration})),g=(0,r.v9)((e=>e.dashboardLayout.present)),f=(0,u.c)(u.T.DASHBOARD_CROSS_FILTERS),v=Cs(),b=f?uu({dataMask:h,chartConfiguration:m,dashboardLayout:g,verboseMaps:v}):[],y=a.length>0||b.length>0;return(0,x.tZ)(lh,Zs(),(0,x.tZ)(dh,null,l?(0,x.tZ)(s.Fragment,null,(0,x.tZ)(ru,null),n&&(0,x.tZ)(uh,{hasFilters:y},(0,x.tZ)(bc,{dashboardId:i,createNewOnOpen:0===a.length},(0,x.tZ)(Y.Z.PlusSmall,null)," ",(0,c.t)("Add/Edit Filters"))),!y&&(0,x.tZ)(ch,null,(0,c.t)("No filters are currently added to this dashboard.")),y&&(0,x.tZ)(sh,{dataMaskSelected:o,onFilterSelectionChange:d}),t):(0,x.tZ)(p.Z,{position:"inline-centered"})))},ph=s.memo(hh),mh=y.iK.div`
  display: none;
`,gh=[Tt.KD.nativeFilters.name,Tt.KD.permalinkKey.name],fh=_()((async(e,t,n,i,r)=>{var o;const{location:s}=e,{search:l}=s,d=new URLSearchParams(l),c=new URLSearchParams;let u;d.forEach(((e,t)=>{a()(gh).call(gh,t)||c.append(t,e)}));const h=(0,_t.eY)(Tt.KD.nativeFiltersKey),p=JSON.stringify(i);u=n&&h&&await(0,$s.TZ)(t,p,h,r)?h:await(0,$s.u7)(t,p,r),u&&c.set(Tt.KD.nativeFiltersKey.name,u),a()(o=window.location.pathname).call(o,"/superset/dashboard")&&(e.location.pathname=window.location.pathname,e.replace({search:c.toString()}))}),gs.M),vh=e=>{let{orientation:t=Fi.Bp.VERTICAL,verticalConfig:n,hidden:i=!1}=e;const o=(0,gi.k6)(),a=Ts(),[l,d]=(0,fs.x)(a),c=(0,r.I0)(),[u,h]=(0,s.useState)(0),p=(0,bs.z)(),m=ks(),g=(0,Pr.D)(m),f=Object.values(m),v=f.filter(no.kI),b=(0,r.v9)((e=>{let{dashboardInfo:t}=e;return null==t?void 0:t.id})),y=(0,Pr.D)(b),S=(0,r.v9)((e=>{let{dashboardInfo:t}=e;return t.dash_edit_perm})),C=(0,s.useCallback)(((e,t)=>{d((n=>{var i,r,o;void 0!==(null==(i=t.filterState)?void 0:i.value)&&void 0===(null==(r=l[e.id])||null==(o=r.filterState)?void 0:o.value)&&e.requiredFirst&&c((0,mt.eG)(e.id,t)),n[e.id]={...(0,vs.H)(e.id),...t}}))}),[l,c,d]);(0,s.useEffect)((()=>{if(g&&b===y){const e={};Object.values(m).forEach((t=>{const n=null==g?void 0:g[t.id];if(!n)return;const i=t.filterType,r=t.targets,o=t.defaultDataMask,a=null==n?void 0:n.filterType,s=null==n?void 0:n.targets,l=null==n?void 0:n.defaultDataMask,d=i!==a,c=!mi()(r,s),u=!mi()(o,l);(d||c||u)&&(e[t.id]=(0,vs.H)(t.id))})),wt()(e)||(d((t=>({...t,...e}))),Object.keys(e).forEach((e=>c((0,mt.ze)(e)))))}}),[JSON.stringify(m),JSON.stringify(g),y]);const Z=JSON.stringify(a);(0,s.useEffect)((()=>{d((()=>a))}),[Z,d]),(0,s.useEffect)((()=>{fh(o,b,u,a,p)}),[b,Z,o,u,p]);const w=(0,s.useCallback)((()=>{const e=Object.keys(l);h(1),e.forEach((e=>{l[e]&&c((0,mt.eG)(e,l[e]))}))}),[l,c]),R=(0,s.useCallback)((()=>{Object.keys(l).forEach((e=>{l[e]&&(c((0,mt.ze)(e)),d((t=>{var n;void 0!==(null==(n=t[e].filterState)?void 0:n.value)&&(t[e].filterState.value=void 0)})))}))}),[l,c,d]);((e,t)=>{const n=ks(),i=Ts();(0,s.useEffect)((()=>{Object.keys(e).forEach((e=>{n[e]||t((t=>{delete t[e]}))}))}),[i,e,n,t])})(l,d);const k=((e,t,n)=>{const i=Object.values(e),r=Object.values(t);return(0,bi.JB)(xs(e),xs(t),{ignoreUndefined:!0})||i.length!==r.length||n.some((t=>{var n;return Ss(t,null==e||null==(n=e[null==t?void 0:t.id])?void 0:n.filterState)}))})(l,a,v),T=(()=>{const[e,t]=(0,s.useState)(!1),n=ks(),i=(0,r.v9)((e=>e.charts));let o=0;return e||(o=document.querySelectorAll('[data-ui-anchor="chart"]').length),(0,s.useEffect)((()=>{if(e)return;if(Object.values(n).find((e=>{let{requiredFirst:t}=e;return t})))return void t(!0);let r;0===o&&(r=setTimeout((()=>{t(!0)}),1e3)),o>0&&void 0!==r&&clearTimeout(r);const a=Object.values(i).filter((e=>{let{chartStatus:t}=e;return"loading"!==t})).length;o>0&&a>=o&&t(!0)}),[i,e,o]),e})(),$=(0,x.tZ)(Fs,{filterBarOrientation:t,width:null==n?void 0:n.width,onApply:w,onClearAll:R,dataMaskSelected:l,dataMaskApplied:a,isApplyDisabled:k}),D=t===Fi.Bp.HORIZONTAL?(0,x.tZ)(ph,{actions:$,canEdit:S,dashboardId:b,dataMaskSelected:l,filterValues:f,isInitialized:T,onSelectionChange:C}):n?(0,x.tZ)(Ou,{actions:$,canEdit:S,dataMaskSelected:l,filtersOpen:n.filtersOpen,filterValues:f,isInitialized:T,isDisabled:k,height:n.height,offset:n.offset,onSelectionChange:C,toggleFiltersBar:n.toggleFiltersBar,width:n.width}):null;return i?(0,x.tZ)(mh,null,D):D},bh=s.memo(vh),yh=y.iK.div`
  position: absolute;
  height: 100%;
...
`,xh=e=>{let{id:t,initialWidth:n,minWidth:i,maxWidth:r,enable:o,children:a}=e;const[l,d]=function(e,t){const n=(0,s.useRef)(),[i,r]=(0,s.useState)(t);return(0,s.useEffect)((()=>{var t;n.current=null!=(t=n.current)?t:(0,J.rV)(J.dR.common__resizable_sidebar_widths,{}),n.current[e]&&r(n.current[e])}),[e]),[i,function(t){r(t),(0,J.LS)(J.dR.common__resizable_sidebar_widths,{...n.current,[e]:t})}]}(t,n);return(0,x.tZ)(s.Fragment,null,(0,x.tZ)(yh,null,(0,x.tZ)(Vo.e,{enable:{right:o},handleClasses:{right:"sidebar-resizer"},size:{width:l,height:"100%"},minWidth:i,maxWidth:r,onResizeStop:(e,t,n,i)=>d(l+i.width)})),a(l))},Sh=e=>{const t=e[X._4],n=null==t?void 0:t.children[0];return n===X.PV?e[X._4]:e[n]},Ch=(e,t)=>"ant-tabs-nav-wrap"===e.target.className||t.contains(e.target);var Zh=n(81545),wh=["className","children","debounceTime","ignoreDimensions","parentSizeStyles","enableDebounceLeadingCall","resizeObserverPolyfill"];function Rh(){return Rh=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(e[i]=n[i])}return e},Rh.apply(this,arguments)}var kh=[],Th={width:"100%",height:"100%"};function $h(e){var t=e.className,n=e.children,i=e.debounceTime,r=void 0===i?300:i,o=e.ignoreDimensions,a=void 0===o?kh:o,l=e.parentSizeStyles,d=void 0===l?Th:l,c=e.enableDebounceLeadingCall,u=void 0===c||c,h=e.resizeObserverPolyfill,p=function(e,t){if(null==e)return{};var n,i,r={},o=Object.keys(e);for(i=0;i<o.length;i++)n=o[i],t.indexOf(n)>=0||(r[n]=e[n]);return r}(e,wh),m=(0,s.useRef)(null),g=(0,s.useRef)(0),f=(0,s.useState)({width:0,height:0,top:0,left:0}),v=f[0],b=f[1],y=(0,s.useMemo)((function(){var e=Array.isArray(a)?a:[a];return _()((function(t){b((function(n){return Object.keys(n).filter((function(e){return n[e]!==t[e]})).every((function(t){return e.includes(t)}))?n:t}))}),r,{leading:u})}),[r,u,a]);return(0,s.useEffect)((function(){var e=new(h||window.ResizeObserver)((function(e){e.forEach((function(e){var t,n=null!=(t=null==e?void 0:e.contentRect)?t:{},i=n.left,r=n.top,o=n.width,a=n.height;g.current=window.requestAnimationFrame((function(){y({width:o,height:a,top:r,left:i})}))}))}));return m.current&&e.observe(m.current),function(){window.cancelAnimationFrame(g.current),e.disconnect(),y.cancel()}}),[y,h]),s.createElement("div",Rh({style:d,ref:m,className:t},p),n(Rh({},v,{ref:m.current,resize:y})))}$h.propTypes={className:d().string,debounceTime:d().number,enableDebounceLeadingCall:d().bool,ignoreDimensions:d().oneOfType([d().any,d().arrayOf(d().any)]),children:d().func.isRequired};var Dh=n(78718),_h=n.n(Dh);const Ih={depth:d().number.isRequired,editMode:d().bool,gridComponent:G.cP,handleComponentDrop:d().func.isRequired,isComponentVisible:d().bool.isRequired,resizeComponent:d().func.isRequired,setDirectPathToChild:d().func.isRequired,width:d().number.isRequired,dashboardId:d().number},Fh=e=>e.dropIndicatorProps&&(0,x.tZ)("div",{className:"drop-indicator drop-indicator--bottom"}),Mh=e=>e.dropIndicatorProps&&(0,x.tZ)("div",{className:"drop-indicator drop-indicator--top"}),Eh=y.iK.div`
  position: absolute;
  top: 0;
  bottom: 0;
  left: 0;
...
`,zh=y.iK.div`
  ...
  `}};
`;class Uh extends s.PureComponent{constructor(e){super(e),this.state={isResizing:!1},this.handleResizeStart=this.handleResizeStart.bind(this),this.handleResizeStop=this.handleResizeStop.bind(this),this.handleTopDropTargetDrop=this.handleTopDropTargetDrop.bind(this),this.getRowGuidePosition=this.getRowGuidePosition.bind(this),this.setGridRef=this.setGridRef.bind(this),this.handleChangeTab=this.handleChangeTab.bind(this)}getRowGuidePosition(e){return e&&this.grid?e.getBoundingClientRect().bottom-this.grid.getBoundingClientRect().top-2:null}setGridRef(e){this.grid=e}handleResizeStart(){this.setState((()=>({isResizing:!0})))}handleResizeStop(e){let{id:t,widthMultiple:n,heightMultiple:i}=e;this.props.resizeComponent({id:t,width:n,height:i}),this.setState((()=>({isResizing:!1})))}handleTopDropTargetDrop(e){e&&this.props.handleComponentDrop({...e,destination:{...e.destination,index:0}})}handleChangeTab(e){let{pathToTabIndex:t}=e;this.props.setDirectPathToChild(t)}render(){var e,t,n;const{gridComponent:i,handleComponentDrop:r,depth:o,width:a,isComponentVisible:l,editMode:d,canEdit:u,setEditMode:h,dashboardId:p}=this.props,m=(a+X.es)/X.cz-X.es,{isResizing:f}=this.state,v=0===(null==i||null==(e=i.children)?void 0:e.length),b=v&&i.type===g.gn,y=d&&(0,x.tZ)(Ba.XJ,{title:(0,c.t)("Drag and drop components and charts to the dashboard"),description:(0,c.t)("You can create a new chart or use existing ones from the panel on the right"),buttonText:(0,x.tZ)(s.Fragment,null,(0,x.tZ)("i",{className:"fa fa-plus"}),(0,c.t)("Create a new chart")),buttonAction:()=>{window.open(`/chart/add?dashboard_id=${p}`,"_blank","noopener noreferrer")},image:"chart.svg"}),S=d?(0,x.tZ)(Ba.XJ,{title:(0,c.t)("Drag and drop components to this tab"),description:(0,c.t)("You can create a new chart or use existing ones from the panel on the right"),buttonText:(0,x.tZ)(s.Fragment,null,(0,x.tZ)("i",{className:"fa fa-plus"}),(0,c.t)("Create a new chart")),buttonAction:()=>{window.open(`/chart/add?dashboard_id=${p}`,"_blank","noopener noreferrer")},image:"chart.svg"}):(0,x.tZ)(Ba.XJ,{title:(0,c.t)("There are no components added to this tab"),description:u&&(0,c.t)("You can add the components in the edit mode."),buttonText:u&&(0,c.t)("Edit the dashboard"),buttonAction:u&&(()=>{h(!0)}),image:"chart.svg"});return a<100?null:(0,x.tZ)(s.Fragment,null,v&&(0,x.tZ)(Eh,null,b?S:y),(0,x.tZ)("div",{className:"dashboard-grid",ref:this.setGridRef},(0,x.tZ)(Oh,{className:"grid-content"},d&&(0,x.tZ)(Ae,{component:i,depth:o,parentComponent:null,index:0,orientation:"column",onDrop:this.handleTopDropTargetDrop,className:"empty-droptarget",editMode:!0},Fh),null==i||null==(t=i.children)?void 0:t.map(((e,t)=>(0,x.tZ)(ms,{key:e,id:e,parentId:i.id,depth:o+1,index:t,availableColumnCount:X.cz,columnWidth:m,isComponentVisible:l,onResizeStart:this.handleResizeStart,onResize:this.handleResize,onResizeStop:this.handleResizeStop,onChangeTab:this.handleChangeTab}))),d&&(null==i||null==(n=i.children)?void 0:n.length)>0&&(0,x.tZ)(Ae,{component:i,depth:o,parentComponent:null,index:i.children.length,orientation:"column",onDrop:r,className:"empty-droptarget",editMode:!0},Mh),f&&Array(X.cz).fill(null).map(((e,t)=>(0,x.tZ)(zh,{key:`grid-column-${t}`,className:"grid-column-guide",style:{left:t*X.es+t*m,width:m}}))))))}}Uh.propTypes=Ih,Uh.defaultProps={};const Ph=Uh,Nh=(0,r.$j)((function(e){let{dashboardState:t,dashboardInfo:n}=e;return{editMode:t.editMode,canEdit:n.dash_edit_perm,dashboardId:n.id}}),(function(e){return(0,i.DE)({handleComponentDrop:Jn._p,resizeComponent:Jn.iO,setDirectPathToChild:Yn.E2,setEditMode:Yn.Mb},e)}))(Ph);var Ah=n(51127),qh=n.n(Ah);const Lh=e=>{let{topLevelTabs:t}=e;const n=(()=>{const e=(0,r.v9)((e=>{var t;return null==(t=e.nativeFilters)?void 0:t.filters}));return(0,s.useMemo)((()=>e?Object.values(e).map((e=>_h()(e,["id","scope","type"]))):[]),[JSON.stringify(e)])})(),i=(0,r.I0)(),o=(0,r.v9)((e=>e.dashboardLayout.present)),a=(0,r.v9)((e=>e.dashboardInfo)),l=(0,r.v9)((e=>e.dashboardState.directPathToChild)),d=(0,r.v9)((e=>Object.values(e.charts).map((e=>e.id)))),c=(0,s.useMemo)((()=>{const e=ns({currentComponent:Sh(o),directPathToChild:l});return e>-1?e:((e,t)=>Math.max(0,ns({currentComponent:Sh(e),directPathToChild:t})))(o,l)}),[o,l]);(0,s.useEffect)((()=>{if(!(0,u.c)(u.T.DASHBOARD_NATIVE_FILTERS)||0===n.length)return;const e=n.map((e=>{if(e.id.startsWith(ws.Ky))return{filterId:e.id,tabsInScope:[],chartsInScope:[]};const t=(0,Mi.Q)(e.scope,d,o),n=(0,dl.Rz)(o,t);return{filterId:e.id,tabsInScope:Array.from(n),chartsInScope:t}}));i((0,al.xk)(e))}),[n,o,i]);const h=(0,s.useCallback)((()=>{const e=a.metadata;if(null!=e&&e.color_scheme){const n={...e},r=null==n?void 0:n.color_scheme,o=(null==n?void 0:n.color_scheme_domain)||[],s=(0,Zh.Z)(),l=s.get(r,!0)||void 0,d=(null==l?void 0:l.colors)||[],c=s.defaultKey,u=!!l,h=()=>{Rt.Z.put({endpoint:`/api/v1/dashboard/${a.id}`,headers:{"Content-Type":"application/json"},body:JSON.stringify({json_metadata:qh()(n)})}).catch((e=>console.log(e)))},p=e=>{i((0,Yn.uW)(e))},m=()=>{i((0,Wn.a8)({metadata:n})),h()};if(u)u&&!o.length&&(n.color_scheme_domain=d,m()),u&&o.length&&d.toString()!==o.toString()&&(n.color_scheme_domain=d,n.shared_label_colors={},p(r),m());else{var t;const e=(null==c?void 0:c.toString())||"supersetColors";n.color_scheme=e,n.color_scheme_domain=(null==(t=s.get(c))?void 0:t.colors)||[],n.shared_label_colors={},p(e),m()}}}),[d]);(0,vd.d)(h);const p=t?t.children:[X.PV],m=Math.min(c,p.length-1),g=0===m?X.PV:m.toString();return(0,x.tZ)("div",{className:"grid-container"},(0,x.tZ)($h,null,(e=>{let{width:t}=e;return(0,x.tZ)(R.ZP,{id:X.PV,activeKey:g,renderTabBar:()=>(0,x.tZ)(s.Fragment,null),fullWidth:!1,animated:!1,allowOverflow:!0},p.map(((e,n)=>(0,x.tZ)(R.ZP.TabPane,{key:0===n?X.PV:n.toString()},(0,x.tZ)(Nh,{gridComponent:o[e],depth:X.Mu+1,width:t,isComponentVisible:n===c})))))})))},jh=y.iK.div`
  ${e=>{let{theme:t}=e;return x.iv`
    display: grid;
