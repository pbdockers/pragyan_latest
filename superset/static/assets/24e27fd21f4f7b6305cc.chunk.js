...
`;function y(e){let{bulkSelectEnabled:t,loading:l,prepareRow:a,renderCard:r,rows:n,showThumbnails:i}=e;return r?(0,f.tZ)(v,{showThumbnails:i},l&&0===n.length&&[...new Array(25)].map(((e,t)=>(0,f.tZ)("div",{key:t},r({loading:l})))),n.length>0&&n.map((e=>r?(a(e),(0,f.tZ)(b,{className:u()({"card-selected":t&&e.isSelected,"bulk-select":t}),key:e.id,onClick:l=>{return a=l,r=e.toggleRowSelected,void(t&&(a.preventDefault(),a.stopPropagation(),r()));var a,r},role:"none"},r({...e.original,loading:l}))):null))):null}var x=l(68135),w=l(4715),S=l(18446),Z=l.n(S),C=l(79521),$=l(35755),k=l(15926),F=l.n(k);const _={encode:e=>void 0===e?void 0:F().encode(e).replace(/%/g,"%25").replace(/&/g,"%26").replace(/\+/g,"%2B").replace(/#/g,"%23"),decode:e=>void 0===e||Array.isArray(e)?void 0:F().decode(e)};class I extends Error{constructor(){super(...arguments),this.name="ListViewError"}}function T(e,t){return e.map((e=>{let{id:l,urlDisplay:a,operator:r}=e;return{id:l,urlDisplay:a,operator:r,value:t[a||l]}}))}function P(e,t){const l=[],a={};return Object.keys(e).forEach((t=>{const r={id:t,value:e[t]};a[t]=r,l.push(r)})),t.forEach((e=>{const t=e.urlDisplay||e.id,l=a[t];l&&(l.operator=e.operator,l.id=e.id)})),l}var U=l(49238);const R=n.iK.div`
  width: ${200}px;
`,M=(0,n.iK)(g.Z.Search)`
...
`,re=e=>{let{mode:t,setMode:l}=e;return(0,f.tZ)(le,null,(0,f.tZ)("div",{role:"button",tabIndex:0,onClick:e=>{e.currentTarget.blur(),l("card")},className:u()("toggle-button",{active:"card"===t})},(0,f.tZ)(g.Z.CardView,null)),(0,f.tZ)("div",{role:"button",tabIndex:0,onClick:e=>{e.currentTarget.blur(),l("table")},className:u()("toggle-button",{active:"table"===t})},(0,f.tZ)(g.Z.ListView,null)))},ne=function(e){let{columns:t,data:l,count:a,pageSize:n,fetchData:s,loading:d,initialSort:u=[],className:g="",filters:p=[],bulkActions:v=[],bulkSelectEnabled:b=!1,disableBulkSelect:x=(()=>{}),renderBulkSelectCopy:w=(e=>(0,i.t)("%s Selected",e.length)),renderCard:S,showThumbnails:k,cardSortSelectOptions:F,defaultViewMode:U="card",highlightRowId:R,emptyState:M,columnsForWrapText:B}=e;const{getTableProps:A,getTableBodyProps:V,headerGroups:E,rows:N,prepareRow:z,pageCount:H=1,gotoPage:O,applyFilterValue:K,selectedFlatRows:D,toggleAllRowsSelected:q,setViewMode:L,state:{pageIndex:X,pageSize:W,internalFilters:G,viewMode:le},query:ne}=function(e){let{fetchData:t,columns:l,data:a,count:r,initialPageSize:n,initialFilters:i=[],initialSort:s=[],bulkSelectMode:d=!1,bulkSelectColumnConfig:u,renderCard:c=!1,defaultViewMode:g="card"}=e;const[p,h]=(0,$.Kx)({filters:_,pageIndex:$.yz,sortColumn:$.Zp,sortOrder:$.Zp,viewMode:$.Zp}),m=(0,o.useMemo)((()=>p.sortColumn&&p.sortOrder?[{id:p.sortColumn,desc:"desc"===p.sortOrder}]:s),[p.sortColumn,p.sortOrder]),f={filters:p.filters?P(p.filters,i):[],pageIndex:p.pageIndex||0,pageSize:n,sortBy:m},[v,b]=(0,o.useState)(p.viewMode||(c?g:"table")),y=(0,o.useMemo)((()=>{const e=l.map((e=>({...e,filter:"exact"})));return d?[u,...e]:e}),[d,l]),{getTableProps:x,getTableBodyProps:w,headerGroups:S,rows:k,prepareRow:F,canPreviousPage:I,canNextPage:U,pageCount:R,gotoPage:M,setAllFilters:B,selectedFlatRows:A,toggleAllRowsSelected:V,state:{pageIndex:E,pageSize:N,sortBy:z,filters:H}}=(0,C.useTable)({columns:y,count:r,data:a,disableFilters:!0,disableSortRemove:!0,initialState:f,manualFilters:!0,manualPagination:!0,manualSortBy:!0,autoResetFilters:!1,pageCount:Math.ceil(r/n)},C.useFilters,C.useSortBy,C.usePagination,C.useRowState,C.useRowSelect),[O,K]=(0,o.useState)(p.filters&&i.length?T(i,p.filters):[]);return(0,o.useEffect)((()=>{i.length&&K(T(i,p.filters?p.filters:{}))}),[i]),(0,o.useEffect)((()=>{const e={};O.forEach((t=>{if(void 0!==t.value&&("string"!=typeof t.value||t.value.length>0)){const l=t.urlDisplay||t.id;e[l]=t.value}}));const l={filters:Object.keys(e).length?e:void 0,pageIndex:E};z[0]&&(l.sortColumn=z[0].id,l.sortOrder=z[0].desc?"desc":"asc"),c&&(l.viewMode=v);const a=void 0!==p.pageIndex&&l.pageIndex!==p.pageIndex?"push":"replace";h(l,a),t({pageIndex:E,pageSize:N,sortBy:z,filters:H})}),[t,E,N,z,H]),(0,o.useEffect)((()=>{Z()(f.pageIndex,E)||M(f.pageIndex)}),[p]),{canNextPage:U,canPreviousPage:I,getTableBodyProps:w,getTableProps:x,gotoPage:M,headerGroups:S,pageCount:R,prepareRow:F,rows:k,selectedFlatRows:A,setAllFilters:B,state:{pageIndex:E,pageSize:N,sortBy:z,filters:H,internalFilters:O,viewMode:v},toggleAllRowsSelected:V,applyFilterValue:(e,t)=>{K((l=>{if(l[e].value===t)return l;const a={...l[e],value:t},r=function(e,t,l){const a=e.find(((e,l)=>t===l));return[...e.slice(0,t),{...a,...l},...e.slice(t+1)]}(l,e,a);return B(r.filter((e=>!(void 0===e.value||Array.isArray(e.value)&&!e.value.length))).map((e=>{let{value:t,operator:l,id:a}=e;return"between"===l&&Array.isArray(t)?[{value:t[0],operator:"gt",id:a},{value:t[1],operator:"lt",id:a}]:{value:t,operator:l,id:a}})).flat()),M(0),r}))},setViewMode:b,query:p}}({bulkSelectColumnConfig:te,bulkSelectMode:b&&Boolean(v.length),columns:t,count:a,data:l,fetchData:s,initialPageSize:n,initialSort:u,initialFilters:p,renderCard:Boolean(S),defaultViewMode:U}),ie=Boolean(p.length);if(ie){const e=t.reduce(((e,t)=>({...e,[t.id||t.accessor]:!0})),{});p.forEach((t=>{if(!e[t.id])throw new I(`Invalid filter config, ${t.id} is not present in columns`)}))}const oe=(0,o.useRef)(null),se=(0,o.useCallback)((()=>{var e;ne.filters&&(null==(e=oe.current)||e.clearFilters())}),[ne.filters]),de=Boolean(S);return(0,o.useEffect)((()=>{b||q(!1)}),[b,q]),(0,f.tZ)(Y,null,(0,f.tZ)("div",{className:`superset-list-view ${g}`},(0,f.tZ)("div",{className:"header"},de&&(0,f.tZ)(re,{mode:le,setMode:L}),(0,f.tZ)("div",{className:"controls"},ie&&(0,f.tZ)(j,{ref:oe,filters:p,internalFilters:G,updateFilterValue:K}),"card"===le&&F&&(0,f.tZ)(J,{initialSort:u,onChange:s,options:F,pageIndex:X,pageSize:W}))),(0,f.tZ)("div",{className:"body "+(0===N.length?"empty":"")},b&&(0,f.tZ)(ee,{type:"info",closable:!0,showIcon:!1,onClose:x,message:(0,f.tZ)(o.Fragment,null,(0,f.tZ)("div",{className:"selectedCopy"},w(D)),Boolean(D.length)&&(0,f.tZ)(o.Fragment,null,(0,f.tZ)("span",{role:"button",tabIndex:0,className:"deselect-all",onClick:()=>q(!1)},(0,i.t)("Deselect all")),(0,f.tZ)("div",{className:"divider"}),v.map((e=>(0,f.tZ)(c.Z,{key:e.key,buttonStyle:e.type,cta:!0,onClick:()=>e.onSelect(D.map((e=>e.original)))},e.name)))))}),"card"===le&&(0,f.tZ)(y,{bulkSelectEnabled:b,prepareRow:z,renderCard:S,rows:N,loading:d,showThumbnails:k}),"table"===le&&(0,f.tZ)(m.Z,{getTableProps:A,getTableBodyProps:V,prepareRow:z,headerGroups:E,rows:N,columns:t,loading:d,highlightRowId:R,columnsForWrapText:B}),!d&&0===N.length&&(0,f.tZ)(ae,{className:le},ne.filters?(0,f.tZ)(Q.XJ,{title:(0,i.t)("No results match your filter criteria"),description:(0,i.t)("Try different criteria to display results."),image:"filter-results.svg",buttonAction:()=>se(),buttonText:(0,i.t)("clear all filters")}):(0,f.tZ)(Q.XJ,r()({},M,{title:(null==M?void 0:M.title)||(0,i.t)("No Data"),image:(null==M?void 0:M.image)||"filter-results.svg"}))))),N.length>0&&(0,f.tZ)("div",{className:"pagination-container"},(0,f.tZ)(h.Z,{totalPages:H||0,currentPage:H?X+1:0,onChange:e=>O(e-1),hideFirstAndLastPageLinks:!0}),(0,f.tZ)("div",{className:"row-count-container"},!d&&(0,i.t)("%s-%s of %s",W*X+(N.length&&1),W*X+N.length,a))))};var ie;!function(e){e.startsWith="sw",e.endsWith="ew",e.contains="ct",e.equals="eq",e.notStartsWith="nsw",e.notEndsWith="new",e.notContains="nct",e.notEquals="neq",e.greaterThan="gt",e.lessThan="lt",e.relationManyMany="rel_m_m",e.relationOneMany="rel_o_m",e.titleOrSlug="title_or_slug",e.nameOrDescription="name_or_description",e.allText="all_text",e.chartAllText="chart_all_text",e.datasetIsNullOrEmpty="dataset_is_null_or_empty",e.between="between",e.dashboardIsFav="dashboard_is_favorite",e.chartIsFav="chart_is_favorite",e.chartIsCertified="chart_is_certified",e.dashboardIsCertified="dashboard_is_certified",e.datasetIsCertified="dataset_is_certified",e.dashboardHasCreatedBy="dashboard_has_created_by",e.chartHasCreatedBy="chart_has_created_by",e.dashboardTags="dashboard_tags",e.chartTags="chart_tags",e.savedQueryTags="saved_query_tags"}(ie||(ie={}))}}]);
//# sourceMappingURL=24e27fd21f4f7b6305cc.chunk.js.map